...
DeviceStateType = Literal["Provisioned", "RegisteredNotSeen", "RegisteredReachable", "RegisteredUnreachable"]
...
FuotaDeviceStatusType = Literal["Device_exist_in_conflict_fuota_task",
    ...
    "Successful",
    "Wrong_descriptor",]
FuotaTaskStatusType = Literal["Delete_Waiting", "FuotaDone", "FuotaSession_Waiting", "In_FuotaSession", "Pending"]
IdentifierTypeType = Literal["DevEui", "GatewayEui", "PartnerAccountId", "WirelessDeviceId", "WirelessGatewayId"]
ImportTaskStatusType = Literal["COMPLETE", "DELETING", "FAILED", "INITIALIZED", "INITIALIZING", "PENDING"]
LogLevelType = Literal["DISABLED", "ERROR", "INFO"]
MessageTypeType = Literal["CUSTOM_COMMAND_ID_GET",
    "CUSTOM_COMMAND_ID_NOTIFY",
    "CUSTOM_COMMAND_ID_RESP",
    "CUSTOM_COMMAND_ID_SET",]
MetricNameType = Literal["AwsAccountActiveDeviceCount",
...
SupportedRfRegionType = Literal["AS923-1",
    "AS923-2",
    "AS923-3",
    "AS923-4",
    "AU915",
...
WirelessDeviceIdTypeType = Literal["DevEui", "SidewalkManufacturingSn", "ThingName", "WirelessDeviceId"]
...
WirelessGatewayTaskStatusType = Literal["COMPLETED", "FAILED", "FIRST_RETRY", "IN_PROGRESS", "PENDING", "SECOND_RETRY"]
...
LoRaWANMulticastSessionUnionTypeDef = Union[   'LoRaWANMulticastSessionTypeDef', 'LoRaWANMulticastSessionOutputTypeDef' ]
WirelessDeviceLogOptionUnionTypeDef = Union[   'WirelessDeviceLogOptionTypeDef', 'WirelessDeviceLogOptionOutputTypeDef' ]
WirelessGatewayLogOptionUnionTypeDef = Union[   'WirelessGatewayLogOptionTypeDef', 'WirelessGatewayLogOptionOutputTypeDef' ]
