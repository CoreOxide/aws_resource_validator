...
ClusterStatusType = Literal["ACTIVE", "CREATE_FAILED", "CREATING", "DELETE_FAILED", "DELETING", "UPDATE_FAILED", "UPDATING"]
ComputeNodeGroupStatusType = Literal["ACTIVE",
    "CREATE_FAILED",
    "CREATING",
    "DELETED",
    "DELETE_FAILED",
...
QueueStatusType = Literal["ACTIVE", "CREATE_FAILED", "CREATING", "DELETE_FAILED", "DELETING", "UPDATE_FAILED", "UPDATING"]
SchedulerTypeType = Literal["SLURM"]
SizeType = Literal["LARGE", "MEDIUM", "SMALL"]
SpotAllocationStrategyType = Literal["capacity-optimized", "lowest-price", "price-capacity-optimized"]
