...
ConnectionStatusType = Literal['CREATE_FAILED', 'CREATING', 'DELETED', 'DELETE_FAILED', 'DELETING', 'READY', 'UPDATE_FAILED', 'UPDATING']
ConnectionTypeType = Literal['ATHENA', 'BIGQUERY', 'DATABRICKS', 'DOCUMENTDB', 'DYNAMODB', 'HYPERPOD', 'IAM', 'MYSQL', 'OPENSEARCH', 'ORACLE', 'POSTGRESQL', 'REDSHIFT', 'SAPHANA', 'SNOWFLAKE', 'SPARK', 'SQLSERVER', 'TERADATA', 'VERTICA', 'WORKFLOWS_MWAA']
DataAssetActivityStatusType = Literal['FAILED', 'PUBLISHING_FAILED', 'SKIPPED_ALREADY_IMPORTED', 'SKIPPED_ARCHIVED', 'SKIPPED_NO_ACCESS', 'SUCCEEDED_CREATED', 'SUCCEEDED_UPDATED', 'UNCHANGED']
DataProductItemTypeType = Literal['ASSET']
DataProductStatusType = Literal['CREATED', 'CREATE_FAILED', 'CREATING']
DataSourceErrorTypeType = Literal['ACCESS_DENIED_EXCEPTION', 'CONFLICT_EXCEPTION', 'INTERNAL_SERVER_EXCEPTION', 'RESOURCE_NOT_FOUND_EXCEPTION', 'SERVICE_QUOTA_EXCEEDED_EXCEPTION', 'THROTTLING_EXCEPTION', 'VALIDATION_EXCEPTION']
...
DataSourceStatusType = Literal['CREATING', 'DELETING', 'FAILED_CREATION', 'FAILED_DELETION', 'FAILED_UPDATE', 'READY', 'RUNNING', 'UPDATING']
...
GlueConnectionTypeType = Literal['BIGQUERY', 'DOCUMENTDB', 'DYNAMODB', 'MYSQL', 'OPENSEARCH', 'ORACLE', 'POSTGRESQL', 'REDSHIFT', 'SAPHANA', 'SNOWFLAKE', 'SQLSERVER', 'TERADATA', 'VERTICA']
...
JobRunStatusType = Literal['ABORTED', 'CANCELED', 'FAILED', 'IN_PROGRESS', 'PARTIALLY_SUCCEEDED', 'SCHEDULED', 'SUCCESS', 'TIMED_OUT']
...
PaginatorName = Literal['list_asset_filters', 'list_asset_revisions', 'list_connections', 'list_data_product_revisions', 'list_data_source_run_activities', 'list_data_source_runs', 'list_data_sources', 'list_domain_units_for_parent', 'list_domains', 'list_entity_owners', 'list_environment_actions', 'list_environment_blueprint_configurations', 'list_environment_blueprints', 'list_environment_profiles', 'list_environments', 'list_job_runs', 'list_lineage_events', 'list_lineage_node_history', 'list_metadata_generation_runs', 'list_notifications', 'list_policy_grants', 'list_project_memberships', 'list_project_profiles', 'list_projects', 'list_rules', 'list_subscription_grants', 'list_subscription_requests', 'list_subscription_targets', 'list_subscriptions', 'list_time_series_data_points', 'search', 'search_group_profiles', 'search_listings', 'search_types', 'search_user_profiles']
...
RegionName = Literal['ap-northeast-1', 'ap-northeast-2', 'ap-northeast-3', 'ap-south-2', 'ap-southeast-1', 'ap-southeast-2', 'ap-southeast-3', 'ap-southeast-4', 'ap-southeast-5', 'ap-southeast-7', 'ca-central-1', 'ca-west-1', 'eu-central-1', 'eu-north-1', 'eu-south-1', 'eu-west-1', 'eu-west-2', 'eu-west-3', 'il-central-1', 'me-central-1', 'me-south-1', 'sa-east-1', 'us-east-1', 'us-east-2', 'us-west-1', 'us-west-2']
...
SelfGrantStatusType = Literal['GRANTED', 'GRANT_FAILED', 'GRANT_IN_PROGRESS', 'GRANT_PENDING', 'REVOKE_FAILED', 'REVOKE_IN_PROGRESS', 'REVOKE_PENDING']
...
SubscriptionGrantOverallStatusType = Literal['COMPLETED', 'GRANT_AND_REVOKE_FAILED', 'GRANT_FAILED', 'INACCESSIBLE', 'IN_PROGRESS', 'PENDING', 'REVOKE_FAILED']
SubscriptionGrantStatusType = Literal['GRANTED', 'GRANT_FAILED', 'GRANT_IN_PROGRESS', 'GRANT_PENDING', 'REVOKED', 'REVOKE_FAILED', 'REVOKE_IN_PROGRESS', 'REVOKE_PENDING']
