...
ExperimentResultRequestTypeType = Literal["BaseStat", "ConfidenceInterval", "PValue", "TreatmentEffect"]
ExperimentResultResponseTypeType = Literal["ConfidenceIntervalLowerBound",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_experiments",
    "list_features",
    "list_launches",
    "list_projects",
