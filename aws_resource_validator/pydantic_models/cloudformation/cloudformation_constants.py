...
ChangeSourceType = Literal[
    "Automatic", "DirectModification", "NoModification", "ParameterReference", "ResourceAttribute", "ResourceReference"
]
...
EventTypeType = Literal[
    "HOOK_INVOCATION_ERROR", "PROGRESS_EVENT", "PROVISIONING_ERROR", "STACK_EVENT", "VALIDATION_ERROR"
]
ExecutionStatusType = Literal[
    "AVAILABLE", "EXECUTE_COMPLETE", "EXECUTE_FAILED", "EXECUTE_IN_PROGRESS", "OBSOLETE", "UNAVAILABLE"
]
...
OperationTypeType = Literal[
    "CONTINUE_ROLLBACK", "CREATE_CHANGESET", "CREATE_STACK", "DELETE_STACK", "ROLLBACK", "UPDATE_STACK"
]
...
ResourceAttributeType = Literal[
    "CreationPolicy", "DeletionPolicy", "Metadata", "Properties", "Tags", "UpdatePolicy", "UpdateReplacePolicy"
]
...
StackInstanceDetailedStatusType = Literal[
    "CANCELLED", "FAILED", "FAILED_IMPORT", "INOPERABLE", "PENDING", "RUNNING", "SKIPPED_SUSPENDED_ACCOUNT", "SUCCEEDED"
]
...
StackRefactorStatusType = Literal[
    "CREATE_COMPLETE", "CREATE_FAILED", "CREATE_IN_PROGRESS", "DELETE_COMPLETE", "DELETE_FAILED", "DELETE_IN_PROGRESS"
]
StackResourceDriftStatusType = Literal["DELETED", "IN_SYNC", "MODIFIED", "NOT_CHECKED", "UNKNOWN", "UNSUPPORTED"]
