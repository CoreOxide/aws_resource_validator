...
AssociatedResourceTypeType = Literal[
    "API_GATEWAY", "APP_RUNNER_SERVICE", "CLOUDFRONT", "COGNITO_USER_POOL", "VERIFIED_ACCESS_INSTANCE"
]
...
FieldToProtectTypeType = Literal["BODY", "QUERY_STRING", "SINGLE_COOKIE", "SINGLE_HEADER", "SINGLE_QUERY_ARGUMENT"]
