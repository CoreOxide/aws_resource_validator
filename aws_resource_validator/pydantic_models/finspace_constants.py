...
EnvironmentStatusType = Literal["CREATED",
    "CREATE_REQUESTED",
    "CREATING",
    "DELETED",
    "DELETE_REQUESTED",
    ...
    "UPDATING_NETWORK",]
ErrorDetailsType = Literal["A user recoverable error has occurred",
...
KxClusterStatusType = Literal["CREATE_FAILED",
    "CREATING",
    "DELETED",
    "DELETE_FAILED",
    "DELETING",
...
KxVolumeStatusType = Literal["ACTIVE",
    "CREATE_FAILED",
    "CREATING",
    "DELETED",
    "DELETE_FAILED",
