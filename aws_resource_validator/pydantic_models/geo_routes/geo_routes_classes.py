...
class RouteDriverOptionsTypeDef(BaseValidatorModel):
    Schedule: Optional[List[RouteDriverScheduleIntervalTypeDef]] = None
...
class RouteRoadTypeDef(BaseValidatorModel):
...
class RouteSignpostLabelTypeDef(BaseValidatorModel):
    RouteNumber: Optional[RouteNumberTypeDef] = None
    Text: Optional[LocalizedStringTypeDef] = None
...
class IsolineAvoidanceAreaTypeDef(BaseValidatorModel):
    ...
    Except: Optional[List[IsolineAvoidanceAreaGeometryTypeDef]] = None


class RouteAvoidanceAreaTypeDef(BaseValidatorModel):
    Geometry: RouteAvoidanceAreaGeometryTypeDef
    Except: Optional[List[RouteAvoidanceAreaGeometryTypeDef]] = None
...
class RouteMatrixAvoidanceOptionsTypeDef(BaseValidatorModel):
    Areas: Optional[List[RouteMatrixAvoidanceAreaTypeDef]] = None
    ...
    ZoneCategories: Optional[List[RouteMatrixAvoidanceZoneCategoryTypeDef]] = None
...
class WaypointOptimizationAvoidanceOptionsTypeDef(BaseValidatorModel):
    Areas: Optional[List[WaypointOptimizationAvoidanceAreaTypeDef]] = None
    CarShuttleTrains: Optional[bool] = None
    ControlledAccessHighways: Optional[bool] = None
    DirtRoads: Optional[bool] = None
    Ferries: Optional[bool] = None
...
class IsolineAvoidanceOptionsTypeDef(BaseValidatorModel):
    Areas: Optional[List[IsolineAvoidanceAreaTypeDef]] = None
    CarShuttleTrains: Optional[bool] = None
    ControlledAccessHighways: Optional[bool] = None
    DirtRoads: Optional[bool] = None
    Ferries: Optional[bool] = None
    ...
    Tunnels: Optional[bool] = None
    UTurns: Optional[bool] = None
    ZoneCategories: Optional[List[IsolineAvoidanceZoneCategoryTypeDef]] = None


class RouteAvoidanceOptionsTypeDef(BaseValidatorModel):
    Areas: Optional[List[RouteAvoidanceAreaTypeDef]] = None
    CarShuttleTrains: Optional[bool] = None
    ControlledAccessHighways: Optional[bool] = None
    DirtRoads: Optional[bool] = None
    Ferries: Optional[bool] = None
    ...
    Tunnels: Optional[bool] = None
    UTurns: Optional[bool] = None
    ZoneCategories: Optional[List[RouteAvoidanceZoneCategoryTypeDef]] = None
...
class SnapToRoadsRequestTypeDef(BaseValidatorModel):
    TracePoints: List[RoadSnapTracePointTypeDef]
...
class RoutePedestrianTravelStepTypeDef(BaseValidatorModel):
    ...
    ContinueStepDetails: Optional[RouteContinueStepDetailsTypeDef] = None
    CurrentRoad: Optional[RouteRoadTypeDef] = None
    Distance: Optional[int] = None
    ExitNumber: Optional[List[LocalizedStringTypeDef]] = None
    GeometryOffset: Optional[int] = None
    Instruction: Optional[str] = None
    KeepStepDetails: Optional[RouteKeepStepDetailsTypeDef] = None
    NextRoad: Optional[RouteRoadTypeDef] = None
    RoundaboutEnterStepDetails: Optional[RouteRoundaboutEnterStepDetailsTypeDef] = None
    RoundaboutExitStepDetails: Optional[RouteRoundaboutExitStepDetailsTypeDef] = None
    RoundaboutPassStepDetails: Optional[RouteRoundaboutPassStepDetailsTypeDef] = None
    Signpost: Optional[RouteSignpostTypeDef] = None
    TurnStepDetails: Optional[RouteTurnStepDetailsTypeDef] = None


class RouteVehicleTravelStepTypeDef(BaseValidatorModel):
    Duration: int
    Type: RouteVehicleTravelStepTypeType
    ContinueHighwayStepDetails: Optional[RouteContinueHighwayStepDetailsTypeDef] = None
    ContinueStepDetails: Optional[RouteContinueStepDetailsTypeDef] = None
    CurrentRoad: Optional[RouteRoadTypeDef] = None
    Distance: Optional[int] = None
    EnterHighwayStepDetails: Optional[RouteEnterHighwayStepDetailsTypeDef] = None
    ExitNumber: Optional[List[LocalizedStringTypeDef]] = None
    ExitStepDetails: Optional[RouteExitStepDetailsTypeDef] = None
    GeometryOffset: Optional[int] = None
    Instruction: Optional[str] = None
    KeepStepDetails: Optional[RouteKeepStepDetailsTypeDef] = None
    NextRoad: Optional[RouteRoadTypeDef] = None
    RampStepDetails: Optional[RouteRampStepDetailsTypeDef] = None
    RoundaboutEnterStepDetails: Optional[RouteRoundaboutEnterStepDetailsTypeDef] = None
    RoundaboutExitStepDetails: Optional[RouteRoundaboutExitStepDetailsTypeDef] = None
    RoundaboutPassStepDetails: Optional[RouteRoundaboutPassStepDetailsTypeDef] = None
    Signpost: Optional[RouteSignpostTypeDef] = None
    TurnStepDetails: Optional[RouteTurnStepDetailsTypeDef] = None
    UTurnStepDetails: Optional[RouteUTurnStepDetailsTypeDef] = None
...
RouteMatrixBoundaryUnionTypeDef = Union[RouteMatrixBoundaryOutputTypeDef, RouteMatrixBoundaryTypeDef]
...
class OptimizeWaypointsRequestTypeDef(BaseValidatorModel):
    ...
    Waypoints: Optional[List[WaypointOptimizationWaypointTypeDef]] = None
...
class CalculateRoutesRequestTypeDef(BaseValidatorModel):
    ...
    Waypoints: Optional[List[RouteWaypointTypeDef]] = None
...
class CalculateRouteMatrixRequestTypeDef(BaseValidatorModel):
    Destinations: List[RouteMatrixDestinationTypeDef]
    Origins: List[RouteMatrixOriginTypeDef]
    ...
    Key: Optional[str] = None
    OptimizeRoutingFor: Optional[RoutingObjectiveType] = None
    RoutingBoundary: Optional[RouteMatrixBoundaryUnionTypeDef] = None
...
class RouteLegTypeDef(BaseValidatorModel):
    ...
    FerryLegDetails: Optional[RouteFerryLegDetailsTypeDef] = None
    Language: Optional[str] = None
    PedestrianLegDetails: Optional[RoutePedestrianLegDetailsTypeDef] = None
    VehicleLegDetails: Optional[RouteVehicleLegDetailsTypeDef] = None
