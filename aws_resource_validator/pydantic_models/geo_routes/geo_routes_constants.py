...
IsolineHazardousCargoTypeType = Literal['Combustible', 'Corrosive', 'Explosive', 'Flammable', 'Gas', 'HarmfulToWater', 'Organic', 'Other', 'Poison', 'PoisonousInhalation', 'Radioactive']
...
RoadSnapHazardousCargoTypeType = Literal['Combustible', 'Corrosive', 'Explosive', 'Flammable', 'Gas', 'HarmfulToWater', 'Organic', 'Other', 'Poison', 'PoisonousInhalation', 'Radioactive']
RoadSnapNoticeCodeType = Literal['TracePointsHeadingIgnored', 'TracePointsIgnored', 'TracePointsMovedByLargeDistance', 'TracePointsNotMatched', 'TracePointsOutOfSequence', 'TracePointsSpeedEstimated', 'TracePointsSpeedIgnored']
...
RouteFerryNoticeCodeType = Literal['AccuratePolylineUnavailable', 'NoSchedule', 'Other', 'SeasonalClosure', 'ViolatedAvoidFerry', 'ViolatedAvoidRailFerry']
RouteFerryTravelStepTypeType = Literal['Arrive', 'Continue', 'Depart']
RouteHazardousCargoTypeType = Literal['Combustible', 'Corrosive', 'Explosive', 'Flammable', 'Gas', 'HarmfulToWater', 'Organic', 'Other', 'Poison', 'PoisonousInhalation', 'Radioactive']
RouteLegAdditionalFeatureType = Literal['Elevation', 'Incidents', 'PassThroughWaypoints', 'Summary', 'Tolls', 'TravelStepInstructions', 'TruckRoadTypes', 'TypicalDuration', 'Zones']
...
RouteMatrixErrorCodeType = Literal['NoMatch', 'NoMatchDestination', 'NoMatchOrigin', 'NoRoute', 'Other', 'OutOfBounds', 'OutOfBoundsDestination', 'OutOfBoundsOrigin', 'Violation']
RouteMatrixHazardousCargoTypeType = Literal['Combustible', 'Corrosive', 'Explosive', 'Flammable', 'Gas', 'HarmfulToWater', 'Organic', 'Other', 'Poison', 'PoisonousInhalation', 'Radioactive']
...
RoutePedestrianNoticeCodeType = Literal['AccuratePolylineUnavailable', 'Other', 'ViolatedAvoidDirtRoad', 'ViolatedAvoidTunnel', 'ViolatedPedestrianOption']
RoutePedestrianTravelStepTypeType = Literal['Arrive', 'Continue', 'Depart', 'Exit', 'Keep', 'Ramp', 'RoundaboutEnter', 'RoundaboutExit', 'RoundaboutPass', 'Turn', 'UTurn']
...
RouteSpanRoadAttributeType = Literal['Bridge', 'BuiltUpArea', 'ControlledAccessHighway', 'DirtRoad', 'DividedRoad', 'Motorway', 'PrivateRoad', 'Ramp', 'RightHandTraffic', 'Roundabout', 'Tunnel', 'UnderConstruction']
...
RouteTollPaymentMethodType = Literal['BankCard', 'Cash', 'CashExact', 'CreditCard', 'PassSubscription', 'Transponder', 'TravelCard', 'VideoToll']
...
WaypointOptimizationConstraintType = Literal['AccessHours', 'AppointmentTime', 'Before', 'Heading', 'ServiceDuration', 'SideOfStreet']
WaypointOptimizationHazardousCargoTypeType = Literal['Combustible', 'Corrosive', 'Explosive', 'Flammable', 'Gas', 'HarmfulToWater', 'Organic', 'Other', 'Poison', 'PoisonousInhalation', 'Radioactive']
