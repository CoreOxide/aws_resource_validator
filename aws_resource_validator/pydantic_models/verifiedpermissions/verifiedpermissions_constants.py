...
BatchGetPolicyErrorCodeType = Literal["POLICY_NOT_FOUND", "POLICY_STORE_ALIAS_NOT_FOUND", "POLICY_STORE_NOT_FOUND"]
...
PaginatorName = Literal[
    "list_identity_sources", "list_policies", "list_policy_store_aliases", "list_policy_stores", "list_policy_templates"
]
RegionName = Literal[
    "af-south-1",
    "ap-east-1",
