...
RouterInputStateType = Literal[
    "ACTIVE", "CREATING", "DELETING", "ERROR", "MIGRATING", "RECOVERING", "STANDBY", "STARTING", "STOPPING", "UPDATING"
]
...
RouterInputTypeType = Literal["FAILOVER", "MEDIACONNECT_FLOW", "MEDIALIVE_CHANNEL", "MERGE", "STANDARD"]
RouterNetworkInterfaceStateType = Literal["ACTIVE", "CREATING", "DELETING", "ERROR", "RECOVERING", "UPDATING"]
