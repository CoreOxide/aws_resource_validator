...
ClusterStateType = Literal["ACTIVE",
    "CREATING",
    "DELETING",
    "FAILED",
    "HEALING",
...
VpcConnectionStateType = Literal["AVAILABLE",
    "CREATING",
    "DEACTIVATING",
    "DELETING",
    "FAILED",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_client_vpc_connections",
...
ClientAuthenticationUnionTypeDef = Union[   'ClientAuthenticationTypeDef', 'ClientAuthenticationExtraOutputTypeDef' ]
BrokerNodeGroupInfoUnionTypeDef = Union[   'BrokerNodeGroupInfoTypeDef', 'BrokerNodeGroupInfoExtraOutputTypeDef' ]
