...
FailureTypeType = Literal["ConfigurationError",
    "JobFailed",
    "PermissionError",
    "RevisionOutOfSync",
    "RevisionUnavailable",
...
JobStatusType = Literal["Created", "Dispatched", "Failed", "InProgress", "Queued", "Succeeded", "TimedOut"]
...
TriggerTypeType = Literal["AutomatedRollback",
    "CloudWatchEvent",
    "CreatePipeline",
    "ManualRollback",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_action_executions",
    "list_action_types",
