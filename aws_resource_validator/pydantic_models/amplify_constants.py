...
DomainStatusType = Literal["AVAILABLE",
    "AWAITING_APP_CNAME",
    "CREATING",
    "FAILED",
    ...
    "UPDATING",]
JobStatusType = Literal["CANCELLED", "CANCELLING", "FAILED", "PENDING", "PROVISIONING", "RUNNING", "SUCCEED"]
...
UpdateStatusType = Literal["AWAITING_APP_CNAME",
    "IMPORTING_CUSTOM_CERTIFICATE",
    "PENDING_DEPLOYMENT",
    "PENDING_VERIFICATION",
    "REQUESTING_CERTIFICATE",
...
AutoBranchCreationConfigUnionTypeDef = Union[   'AutoBranchCreationConfigTypeDef', 'AutoBranchCreationConfigExtraOutputTypeDef' ]
