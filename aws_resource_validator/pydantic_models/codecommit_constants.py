...
BatchGetRepositoriesErrorCodeEnumType = Literal["EncryptionIntegrityChecksFailedException",
...
ConflictResolutionStrategyTypeEnumType = Literal["ACCEPT_DESTINATION", "ACCEPT_SOURCE", "AUTOMERGE", "NONE"]
...
PullRequestEventTypeType = Literal["PULL_REQUEST_APPROVAL_RULE_CREATED",
...
RepositoryTriggerEventEnumType = Literal["all", "createReference", "deleteReference", "updateReference"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["describe_pull_request_events",
