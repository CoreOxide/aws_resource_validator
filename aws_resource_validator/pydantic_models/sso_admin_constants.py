...
GrantTypeType = Literal["authorization_code",
    "refresh_token",
    "urn:ietf:params:oauth:grant-type:jwt-bearer",
    "urn:ietf:params:oauth:grant-type:token-exchange",]
InstanceAccessControlAttributeConfigurationStatusType = Literal["CREATION_FAILED", "CREATION_IN_PROGRESS", "ENABLED"]
InstanceStatusType = Literal["ACTIVE", "CREATE_IN_PROGRESS", "DELETE_IN_PROGRESS"]
JwksRetrievalOptionType = Literal["OPEN_ID_DISCOVERY"]
ListAccountAssignmentCreationStatusPaginatorName = Literal["list_account_assignment_creation_status"]
...
ListAccountsForProvisionedPermissionSetPaginatorName = Literal["list_accounts_for_provisioned_permission_set"]
ListApplicationAccessScopesPaginatorName = Literal["list_application_access_scopes"]
ListApplicationAssignmentsForPrincipalPaginatorName = Literal["list_application_assignments_for_principal"]
ListApplicationAssignmentsPaginatorName = Literal["list_application_assignments"]
ListApplicationAuthenticationMethodsPaginatorName = Literal["list_application_authentication_methods"]
...
ListCustomerManagedPolicyReferencesInPermissionSetPaginatorName = Literal["list_customer_managed_policy_references_in_permission_set"]
...
ListPermissionSetProvisioningStatusPaginatorName = Literal["list_permission_set_provisioning_status"]
ListPermissionSetsPaginatorName = Literal["list_permission_sets"]
ListPermissionSetsProvisionedToAccountPaginatorName = Literal["list_permission_sets_provisioned_to_account"]
...
ProvisioningStatusType = Literal["LATEST_PERMISSION_SET_NOT_PROVISIONED", "LATEST_PERMISSION_SET_PROVISIONED"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_account_assignment_creation_status",
