...
BatchStatementErrorCodeEnumType = Literal["AccessDenied",
...
ReplicaStatusType = Literal["ACTIVE",
    "CREATING",
    "CREATION_FAILED",
    "DELETING",
...
TableStatusType = Literal["ACTIVE",
    "ARCHIVED",
    "ARCHIVING",
    "CREATING",
    "DELETING",
...
GlobalSecondaryIndexUnionTypeDef = Union[   'GlobalSecondaryIndexTypeDef', 'GlobalSecondaryIndexOutputTypeDef' ]
KeysAndAttributesUnionTypeDef = Union['KeysAndAttributesTypeDef', 'KeysAndAttributesOutputTypeDef']
WriteRequestServiceResourceUnionTypeDef = Union[   'WriteRequestServiceResourceTypeDef', 'WriteRequestServiceResourceOutputTypeDef' ]
TableCreationParametersUnionTypeDef = Union[   'TableCreationParametersTypeDef', 'TableCreationParametersOutputTypeDef' ]
