...
AIPromptTypeType = Literal['ANSWER_GENERATION', 'INTENT_LABELING_GENERATION', 'QUERY_REFORMULATION', 'SELF_SERVICE_ANSWER_GENERATION', 'SELF_SERVICE_PRE_PROCESSING']
AssistantCapabilityTypeType = Literal['V1', 'V2']
AssistantStatusType = Literal['ACTIVE', 'CREATE_FAILED', 'CREATE_IN_PROGRESS', 'DELETED', 'DELETE_FAILED', 'DELETE_IN_PROGRESS']
...
ContentStatusType = Literal['ACTIVE', 'CREATE_FAILED', 'CREATE_IN_PROGRESS', 'DELETED', 'DELETE_FAILED', 'DELETE_IN_PROGRESS', 'UPDATE_FAILED']
...
KnowledgeBaseStatusType = Literal['ACTIVE', 'CREATE_FAILED', 'CREATE_IN_PROGRESS', 'DELETED', 'DELETE_FAILED', 'DELETE_IN_PROGRESS']
...
PaginatorName = Literal['list_ai_agent_versions', 'list_ai_agents', 'list_ai_guardrail_versions', 'list_ai_guardrails', 'list_ai_prompt_versions', 'list_ai_prompts', 'list_assistant_associations', 'list_assistants', 'list_content_associations', 'list_contents', 'list_import_jobs', 'list_knowledge_bases', 'list_message_template_versions', 'list_message_templates', 'list_messages', 'list_quick_responses', 'query_assistant', 'search_content', 'search_message_templates', 'search_quick_responses', 'search_sessions']
...
QuickResponseStatusType = Literal['CREATED', 'CREATE_FAILED', 'CREATE_IN_PROGRESS', 'DELETED', 'DELETE_FAILED', 'DELETE_IN_PROGRESS', 'UPDATE_FAILED', 'UPDATE_IN_PROGRESS']
...
RegionName = Literal['ap-northeast-1', 'ap-northeast-2', 'ap-southeast-1', 'ap-southeast-2', 'ca-central-1', 'eu-central-1', 'eu-west-2', 'us-east-1', 'us-west-2']
