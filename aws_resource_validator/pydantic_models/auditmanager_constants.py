...
DataSourceTypeType = Literal["AWS_API_Call", "AWS_Cloudtrail", "AWS_Config", "AWS_Security_Hub", "MANUAL"]
...
EvidenceFinderEnablementStatusType = Literal["DISABLED", "DISABLE_IN_PROGRESS", "ENABLED", "ENABLE_IN_PROGRESS"]
...
ObjectTypeEnumType = Literal["ASSESSMENT", "ASSESSMENT_REPORT", "CONTROL", "CONTROL_SET", "DELEGATION"]
RoleTypeType = Literal["PROCESS_OWNER", "RESOURCE_OWNER"]
SettingAttributeType = Literal["ALL",
...
ShareRequestStatusType = Literal["ACTIVE", "DECLINED", "EXPIRED", "EXPIRING", "FAILED", "REPLICATING", "REVOKED", "SHARED"]
...
SourceTypeType = Literal["AWS_API_Call",
    "AWS_Cloudtrail",
    "AWS_Config",
    "AWS_Security_Hub",
    "Common_Control",
