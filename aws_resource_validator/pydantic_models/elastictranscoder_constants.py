...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_jobs_by_pipeline", "list_jobs_by_status", "list_pipelines", "list_presets"]
...
RegionName = Literal["ap-northeast-1",
    ...
    "us-west-1",
    "us-west-2",]
PipelineOutputConfigUnionTypeDef = Union[   'PipelineOutputConfigTypeDef', 'PipelineOutputConfigExtraOutputTypeDef' ]
