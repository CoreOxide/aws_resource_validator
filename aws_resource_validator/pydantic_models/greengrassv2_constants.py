...
EffectiveDeploymentExecutionStatusType = Literal["CANCELED", "COMPLETED", "FAILED", "IN_PROGRESS", "QUEUED", "REJECTED", "SUCCEEDED", "TIMED_OUT"]
InstalledComponentLifecycleStateType = Literal["BROKEN", "ERRORED", "FINISHED", "INSTALLED", "NEW", "RUNNING", "STARTING", "STOPPING"]
...
ListClientDevicesAssociatedWithCoreDevicePaginatorName = Literal["list_client_devices_associated_with_core_device"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_client_devices_associated_with_core_device",
