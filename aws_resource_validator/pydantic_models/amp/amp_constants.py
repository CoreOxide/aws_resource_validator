...
AnomalyDetectorStatusCodeType = Literal[
    "ACTIVE", "CREATING", "CREATION_FAILED", "DELETING", "DELETION_FAILED", "UPDATE_FAILED", "UPDATING"
]
...
PaginatorName = Literal["list_anomaly_detectors", "list_rule_groups_namespaces", "list_scrapers", "list_workspaces"]
WaiterName = Literal[
