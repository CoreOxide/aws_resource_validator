...
ApplicationVersionStatusType = Literal["Building", "Failed", "Processed", "Processing", "Unprocessed"]
...
DescribeEnvironmentManagedActionHistoryPaginatorName = Literal["describe_environment_managed_action_history"]
...
EnvironmentHealthAttributeType = Literal["All",
    "ApplicationMetrics",
    "Causes",
    "Color",
    "HealthStatus",
    ...
    "RefreshedAt",
    "Status",]
EnvironmentHealthStatusType = Literal["Degraded", "Info", "NoData", "Ok", "Pending", "Severe", "Suspended", "Unknown", "Warning"]
EnvironmentHealthType = Literal["Green", "Grey", "Red", "Yellow"]
EnvironmentInfoTypeType = Literal["bundle", "tail"]
EnvironmentStatusType = Literal["Aborting",
    "Launching",
    "LinkingFrom",
    "LinkingTo",
    "Ready",
...
FailureTypeType = Literal["CancellationFailed",
    "InternalFailure",
    ...
    "RollbackSuccessful",
    "UpdateCancelled",]
InstancesHealthAttributeType = Literal["All",
    "ApplicationMetrics",
    "AvailabilityZone",
    "Causes",
    "Color",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["describe_application_versions",
