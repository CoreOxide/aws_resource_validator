...
AssetTypeType = Literal["API_GATEWAY_API",
    "LAKE_FORMATION_DATA_PERMISSION",
    "REDSHIFT_DATA_SHARE",
    "S3_DATA_ACCESS",
    "S3_SNAPSHOT",]
CodeType = Literal["ACCESS_DENIED_EXCEPTION",
...
JobErrorLimitNameType = Literal["AWS Lake Formation data permission assets per revision",
...
TypeType = Literal["CREATE_S3_DATA_ACCESS_FROM_S3_BUCKET",
    "EXPORT_ASSETS_TO_S3",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_data_set_revisions",
    "list_data_sets",
    "list_event_actions",
    "list_jobs",
