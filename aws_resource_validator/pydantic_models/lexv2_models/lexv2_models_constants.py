...
AnalyticsIntentFilterNameType = Literal['BotAliasId', 'BotVersion', 'Channel', 'IntentEndState', 'IntentName', 'LocaleId', 'Modality', 'OriginatingRequestId', 'SessionId']
...
AnalyticsIntentStageFilterNameType = Literal['BotAliasId', 'BotVersion', 'Channel', 'IntentName', 'IntentStageName', 'LocaleId', 'Modality', 'OriginatingRequestId', 'SessionId']
...
AnalyticsSessionFilterNameType = Literal['BotAliasId', 'BotVersion', 'Channel', 'ConversationEndState', 'Duration', 'IntentPath', 'LocaleId', 'Modality', 'OriginatingRequestId', 'SessionId']
...
AnalyticsUtteranceFilterNameType = Literal['BotAliasId', 'BotVersion', 'Channel', 'LocaleId', 'Modality', 'OriginatingRequestId', 'SessionId', 'UtteranceState', 'UtteranceText']
...
BotLocaleStatusType = Literal['Building', 'Built', 'Creating', 'Deleting', 'Failed', 'Importing', 'NotBuilt', 'Processing', 'ReadyExpressTesting']
BotRecommendationStatusType = Literal['Available', 'Deleted', 'Deleting', 'Downloading', 'Failed', 'Processing', 'Stopped', 'Stopping', 'Updating']
...
DialogActionTypeType = Literal['CloseIntent', 'ConfirmIntent', 'ElicitIntent', 'ElicitSlot', 'EndConversation', 'EvaluateConditional', 'FulfillIntent', 'InvokeDialogCodeHook', 'StartIntent']
EffectType = Literal['Allow', 'Deny']
ErrorCodeType = Literal['DUPLICATE_INPUT', 'INTERNAL_SERVER_FAILURE', 'RESOURCE_ALREADY_EXISTS', 'RESOURCE_DOES_NOT_EXIST']
...
RegionName = Literal['af-south-1', 'ap-northeast-1', 'ap-northeast-2', 'ap-southeast-1', 'ap-southeast-2', 'ca-central-1', 'eu-central-1', 'eu-west-1', 'eu-west-2', 'us-east-1', 'us-west-2']
...
TestResultTypeFilterType = Literal['ConversationLevelTestResults', 'IntentClassificationTestResults', 'OverallTestResults', 'SlotResolutionTestResults', 'UtteranceLevelResults']
...
WaiterName = Literal['bot_alias_available', 'bot_available', 'bot_export_completed', 'bot_import_completed', 'bot_locale_built', 'bot_locale_created', 'bot_locale_express_testing_available', 'bot_version_available']