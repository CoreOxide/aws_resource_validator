...
ApplicationPermissionType = Literal["AccessNotebooks",
    "CreateDataset",
...
ColumnDataTypeType = Literal["BIGINT",
    "BINARY",
    "BOOLEAN",
    "CHAR",
    "DATE",
    ...
    "STRING",
    "TINYINT",]
DataViewStatusType = Literal["CANCELLED",
    "FAILED",
...
ErrorCategoryType = Literal["ACCESS_DENIED",
    "CANCELLED",
...
PermissionGroupMembershipStatusType = Literal["ADDITION_IN_PROGRESS", "ADDITION_SUCCESS", "REMOVAL_IN_PROGRESS"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_changesets", "list_data_views", "list_datasets", "list_permission_groups", "list_users"]
