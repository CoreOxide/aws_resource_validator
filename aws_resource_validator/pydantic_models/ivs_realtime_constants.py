...
RegionName = Literal["ap-northeast-1",
    ...
    "us-east-1",
    "us-west-2",]
AutoParticipantRecordingConfigurationUnionTypeDef = Union[   'AutoParticipantRecordingConfigurationTypeDef', 'AutoParticipantRecordingConfigurationOutputTypeDef' ]
DestinationConfigurationUnionTypeDef = Union[   'DestinationConfigurationTypeDef', 'DestinationConfigurationOutputTypeDef' ]
