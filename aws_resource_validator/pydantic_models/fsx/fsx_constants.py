...
LustreReadCacheSizingModeType = Literal["NO_CACHE", "PROPORTIONAL_TO_THROUGHPUT_CAPACITY", "USER_PROVISIONED"]
...
StatusType = Literal[
    "CANCELLED", "COMPLETED", "FAILED", "IN_PROGRESS", "OPTIMIZING", "PAUSED", "PENDING", "UPDATED_OPTIMIZING"
]
