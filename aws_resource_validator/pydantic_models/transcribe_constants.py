...
CallAnalyticsSkippedReasonCodeType = Literal["FAILED_SAFETY_GUIDELINES", "INSUFFICIENT_CONVERSATION_CONTENT"]
InputTypeType = Literal["POST_CALL", "REAL_TIME"]
LanguageCodeType = Literal["ab-GE",
    "af-ZA",
    "ar-AE",
    "ar-SA",
    "ast-ES",
...
ToxicityDetectionSettingsUnionTypeDef = Union[   'ToxicityDetectionSettingsTypeDef', 'ToxicityDetectionSettingsOutputTypeDef' ]
CallAnalyticsJobSettingsUnionTypeDef = Union[   'CallAnalyticsJobSettingsTypeDef', 'CallAnalyticsJobSettingsOutputTypeDef' ]
