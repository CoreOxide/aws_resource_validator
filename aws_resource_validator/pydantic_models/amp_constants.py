...
AlertManagerDefinitionStatusCodeType = Literal["ACTIVE", "CREATING", "CREATION_FAILED", "DELETING", "UPDATE_FAILED", "UPDATING"]
...
LoggingConfigurationStatusCodeType = Literal["ACTIVE", "CREATING", "CREATION_FAILED", "DELETING", "UPDATE_FAILED", "UPDATING"]
RuleGroupsNamespaceStatusCodeType = Literal["ACTIVE", "CREATING", "CREATION_FAILED", "DELETING", "UPDATE_FAILED", "UPDATING"]
ScraperActiveWaiterName = Literal["scraper_active"]
ScraperDeletedWaiterName = Literal["scraper_deleted"]
ScraperStatusCodeType = Literal["ACTIVE", "CREATING", "CREATION_FAILED", "DELETING", "DELETION_FAILED"]
