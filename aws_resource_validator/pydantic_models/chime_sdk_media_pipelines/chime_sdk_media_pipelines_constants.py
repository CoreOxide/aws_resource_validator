...
MediaInsightsPipelineConfigurationElementTypeType = Literal['AmazonTranscribeCallAnalyticsProcessor', 'AmazonTranscribeProcessor', 'KinesisDataStreamSink', 'LambdaFunctionSink', 'S3RecordingSink', 'SnsTopicSink', 'SqsQueueSink', 'VoiceAnalyticsProcessor', 'VoiceEnhancementSink']
MediaPipelineElementStatusType = Literal['Failed', 'InProgress', 'Initializing', 'NotStarted', 'NotSupported', 'Paused', 'Stopped', 'Stopping']
...
RegionName = Literal['ap-northeast-1', 'ap-northeast-2', 'ap-south-1', 'ap-southeast-1', 'ap-southeast-2', 'ca-central-1', 'eu-central-1', 'eu-west-2', 'us-east-1', 'us-west-2']
