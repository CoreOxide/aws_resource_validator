...
AppAuthorizationStatusType = Literal["Connected", "ConnectionValidationFailed", "PendingConnect", "TokenAutoRotationFailed"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_app_authorizations", "list_app_bundles", "list_ingestion_destinations", "list_ingestions"]
