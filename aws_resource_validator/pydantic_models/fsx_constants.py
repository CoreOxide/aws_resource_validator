...
AdministrativeActionTypeType = Literal["DOWNLOAD_DATA_FROM_BACKUP",
...
DataRepositoryTaskTypeType = Literal["AUTO_RELEASE_DATA",
...
FileSystemLifecycleType = Literal["AVAILABLE",
    "CREATING",
    "DELETING",
    "FAILED",
    "MISCONFIGURED",
...
FilterNameType = Literal["backup-type",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["describe_backups",
...
RegionName = Literal["af-south-1",
    ...
    "us-west-1",
    "us-west-2",]
S3DataRepositoryConfigurationUnionTypeDef = Union[   'S3DataRepositoryConfigurationTypeDef', 'S3DataRepositoryConfigurationOutputTypeDef' ]
