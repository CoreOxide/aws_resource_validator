...
ListOrganizationRecommendationAccountsPaginatorName = Literal["list_organization_recommendation_accounts"]
ListOrganizationRecommendationResourcesPaginatorName = Literal["list_organization_recommendation_resources"]
...
RecommendationLanguageType = Literal["de", "en", "es", "fr", "id", "it", "ja", "ko", "pt_BR", "zh", "zh_TW"]
RecommendationLifecycleStageType = Literal["dismissed", "in_progress", "pending_response", "resolved"]
RecommendationPillarType = Literal[
    "cost_optimizing", "fault_tolerance", "operational_excellence", "performance", "security", "service_limits"
]
...
UpdateRecommendationLifecycleStageType = Literal["dismissed", "in_progress", "pending_response", "resolved"]
...
RegionName = Literal["ap-northeast-2", "ap-southeast-2", "eu-west-1", "us-east-1", "us-east-2", "us-west-2"]
