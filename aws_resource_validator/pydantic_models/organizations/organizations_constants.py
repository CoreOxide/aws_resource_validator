...
ListAWSServiceAccessForOrganizationPaginatorName = Literal["list_aws_service_access_for_organization"]
ListAccountsForParentPaginatorName = Literal["list_accounts_for_parent"]
ListAccountsPaginatorName = Literal["list_accounts"]
ListAccountsWithInvalidEffectivePolicyPaginatorName = Literal["list_accounts_with_invalid_effective_policy"]
...
ListEffectivePolicyValidationErrorsPaginatorName = Literal["list_effective_policy_validation_errors"]
...
ResponsibilityTransferStatusType = Literal["ACCEPTED", "CANCELED", "DECLINED", "EXPIRED", "REQUESTED", "WITHDRAWN"]
