...
LicenseServerEndpointProvisioningStatusType = Literal["DELETED", "DELETING", "DELETION_FAILED", "PROVISIONED", "PROVISIONING", "PROVISIONING_FAILED"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_identity_providers",
    "list_instances",
