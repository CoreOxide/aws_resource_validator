...
BaselineOperationTypeType = Literal["DISABLE_BASELINE", "ENABLE_BASELINE", "RESET_ENABLED_BASELINE", "UPDATE_ENABLED_BASELINE"]
ControlOperationStatusType = Literal["FAILED", "IN_PROGRESS", "SUCCEEDED"]
ControlOperationTypeType = Literal["DISABLE_CONTROL", "ENABLE_CONTROL", "RESET_ENABLED_CONTROL", "UPDATE_ENABLED_CONTROL"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_baselines",
