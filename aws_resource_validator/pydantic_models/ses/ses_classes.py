...
class ConnectActionTypeDef(BaseValidatorModel):
    InstanceARN: Annotated[str, _aws_pattern("Ses", "ConnectInstanceArn")]
    IAMRoleARN: Annotated[str, _aws_pattern("Ses", "IAMRoleARN")]
...
class S3ActionTypeDef(BaseValidatorModel):
    ...
    IamRoleArn: Optional[Annotated[str, _aws_pattern("Ses", "IAMRoleARN")]] = None
