...
ComparisonOperatorType = Literal["BEGINS_WITH", "BETWEEN", "CONTAINS", "EQ", "GE", "GT", "IN", "LE", "LT", "NE", "NOT_CONTAINS"]
DataLakeResourceTypeType = Literal["CATALOG",
    "DATABASE",
    "DATA_LOCATION",
    "LF_TAG",
    "LF_TAG_POLICY",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["get_work_units",
...
ExternalFilteringConfigurationUnionTypeDef = Union[   'ExternalFilteringConfigurationTypeDef', 'ExternalFilteringConfigurationOutputTypeDef' ]
...
BatchPermissionsRequestEntryUnionTypeDef = Union[   'BatchPermissionsRequestEntryTypeDef', 'BatchPermissionsRequestEntryOutputTypeDef' ]
