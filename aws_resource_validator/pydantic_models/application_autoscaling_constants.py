...
ScalableDimensionType = Literal["appstream:fleet:DesiredCapacity",
...
ScalingActivityStatusCodeType = Literal["Failed", "InProgress", "Overridden", "Pending", "Successful", "Unfulfilled"]
ServiceNamespaceType = Literal["appstream",
    "cassandra",
    "comprehend",
    "custom-resource",
    "dynamodb",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["describe_scalable_targets",
...
StepScalingPolicyConfigurationUnionTypeDef = Union[   'StepScalingPolicyConfigurationTypeDef', 'StepScalingPolicyConfigurationExtraOutputTypeDef' ]
TargetTrackingScalingPolicyConfigurationUnionTypeDef = Union[   'TargetTrackingScalingPolicyConfigurationTypeDef',   'TargetTrackingScalingPolicyConfigurationExtraOutputTypeDef', ]
