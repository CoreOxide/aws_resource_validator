...
SourceTypeType = Literal['cache-cluster', 'cache-parameter-group', 'cache-security-group', 'cache-subnet-group', 'replication-group', 'serverless-cache', 'serverless-cache-snapshot', 'user', 'user-group']
TransitEncryptionModeType = Literal['preferred', 'required']
UpdateActionStatusType = Literal['complete', 'in-progress', 'not-applicable', 'not-applied', 'scheduled', 'scheduling', 'stopped', 'stopping', 'waiting-to-start']
WaiterName = Literal['cache_cluster_available', 'cache_cluster_deleted', 'replication_group_available', 'replication_group_deleted']