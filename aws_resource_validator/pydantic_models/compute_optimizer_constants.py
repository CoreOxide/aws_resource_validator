...
EBSMetricNameType = Literal["VolumeReadBytesPerSecond",
    "VolumeReadOpsPerSecond",
    "VolumeWriteBytesPerSecond",
    "VolumeWriteOpsPerSecond",]
EBSSavingsEstimationModeSourceType = Literal["CostExplorerRightsizing", "CostOptimizationHub", "PublicPricing"]
ECSSavingsEstimationModeSourceType = Literal["CostExplorerRightsizing", "CostOptimizationHub", "PublicPricing"]
...
ECSServiceRecommendationFindingReasonCodeType = Literal["CPUOverprovisioned", "CPUUnderprovisioned", "MemoryOverprovisioned", "MemoryUnderprovisioned"]
...
ExportableAutoScalingGroupFieldType = Literal["AccountId",
    "AutoScalingGroupArn",
...
ExportableECSServiceFieldType = Literal["AccountId",
    "CurrentPerformanceRisk",
    ...
    "UtilizationMetricsCpuMaximum",
    "UtilizationMetricsMemoryMaximum",]
ExportableIdleFieldType = Literal["AccountId",
    "Finding",
    "FindingDescription",
    "LastRefreshTimestamp",
    "LookbackPeriodInDays",
...
ExportableInstanceFieldType = Literal["AccountId",
    "CurrentInstanceGpuInfo",
    "CurrentInstanceType",
    "CurrentMemory",
    "CurrentNetwork",
    ...
    "UtilizationMetricsNetworkPacketsInPerSecondMaximum",
    "UtilizationMetricsNetworkPacketsOutPerSecondMaximum",]
ExportableLambdaFunctionFieldType = Literal["AccountId",
    ...
    "UtilizationMetricsMemoryMaximum",]
ExportableLicenseFieldType = Literal["AccountId",
    ...
    "ResourceArn",
    "Tags",]
ExportableRDSDBFieldType = Literal["AccountId",
...
ExportableVolumeFieldType = Literal["AccountId",
    ...
    "UtilizationMetricsVolumeWriteOpsPerSecondMaximum",
    "VolumeArn",]
ExternalMetricStatusCodeType = Literal["DATADOG_INTEGRATION_ERROR",
...
FilterNameType = Literal["Finding", "FindingReasonCodes", "InferredWorkloadTypes", "RecommendationSourceType"]
...
GetEnrollmentStatusesForOrganizationPaginatorName = Literal["get_enrollment_statuses_for_organization"]
...
IdleMetricNameType = Literal["CPU",
    "DatabaseConnections",
    "EBSVolumeReadIOPS",
    "EBSVolumeWriteIOPS",
    "Memory",
...
IdleRecommendationResourceTypeType = Literal["AutoScalingGroup", "EBSVolume", "EC2Instance", "ECSService", "RDSDBInstance"]
IdleType = Literal["False", "True"]
InferredWorkloadTypeType = Literal["AmazonEmr",
    "ApacheCassandra",
    "ApacheHadoop",
    "Kafka",
    "Memcached",
...
InstanceRecommendationFindingReasonCodeType = Literal["CPUOverprovisioned",
    "CPUUnderprovisioned",
...
InstanceSavingsEstimationModeSourceType = Literal["CostExplorerRightsizing", "CostOptimizationHub", "PublicPricing"]
InstanceStateType = Literal["pending", "running", "shutting-down", "stopped", "stopping", "terminated"]
...
LambdaFunctionRecommendationFindingReasonCodeType = Literal["Inconclusive", "InsufficientData", "MemoryOverprovisioned", "MemoryUnderprovisioned"]
LambdaFunctionRecommendationFindingType = Literal["NotOptimized", "Optimized", "Unavailable"]
LambdaSavingsEstimationModeSourceType = Literal["CostExplorerRightsizing", "CostOptimizationHub", "PublicPricing"]
LicenseEditionType = Literal["Enterprise", "Free", "NoLicenseEditionFound", "Standard"]
LicenseFindingReasonCodeType = Literal["CloudWatchApplicationInsightsError",
...
PlatformDifferenceType = Literal["Architecture",
    "Hypervisor",
...
RDSDBMetricNameType = Literal["AuroraMemoryHealthState",
...
RDSDBRecommendationFilterNameType = Literal["Idle",
    "InstanceFinding",
    "InstanceFindingReasonCode",
    "StorageFinding",
    "StorageFindingReasonCode",]
RDSInstanceFindingReasonCodeType = Literal["CPUOverprovisioned",
    "CPUUnderprovisioned",
...
RDSSavingsEstimationModeSourceType = Literal["CostExplorerRightsizing", "CostOptimizationHub", "PublicPricing"]
RDSStorageFindingReasonCodeType = Literal["EBSVolumeAllocatedStorageUnderprovisioned",
...
RecommendationSourceTypeType = Literal["AutoScalingGroup",
    "EbsVolume",
    "Ec2Instance",
    "EcsService",
    "LambdaFunction",
...
ResourceTypeType = Literal["AutoScalingGroup",
    "EbsVolume",
    "Ec2Instance",
    "EcsService",
    "Idle",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["describe_recommendation_export_jobs",
