...
PhoneNumberOrderStatusType = Literal["CancelRequested",
    "Cancelled",
    "ChangeRequested",
    "Exception",
    "FOC",
...
PhoneNumberStatusType = Literal["AcquireFailed",
    "AcquireInProgress",
    "Assigned",
    "Cancelled",
    "DeleteFailed",
...
VoiceConnectorAwsRegionType = Literal["ap-northeast-1",
    "ap-northeast-2",
    "ap-southeast-1",
    "ap-southeast-2",
    "ca-central-1",
...
RegionName = Literal["ap-northeast-1",
    ...
    "us-east-1",
    "us-west-2",]
SipMediaApplicationAlexaSkillConfigurationUnionTypeDef = Union[   'SipMediaApplicationAlexaSkillConfigurationTypeDef',   'SipMediaApplicationAlexaSkillConfigurationOutputTypeDef', ]
TerminationUnionTypeDef = Union['TerminationTypeDef', 'TerminationOutputTypeDef']
EmergencyCallingConfigurationUnionTypeDef = Union[   'EmergencyCallingConfigurationTypeDef', 'EmergencyCallingConfigurationOutputTypeDef' ]
OriginationUnionTypeDef = Union['OriginationTypeDef', 'OriginationOutputTypeDef']
StreamingConfigurationUnionTypeDef = Union[   'StreamingConfigurationTypeDef', 'StreamingConfigurationOutputTypeDef' ]
