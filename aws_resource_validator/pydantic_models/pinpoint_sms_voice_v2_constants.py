...
ConfigurationSetFilterNameType = Literal["default-message-feedback-enabled",
...
DescribeRegistrationinitionsPaginatorName = Literal["describe_registration_type_definitions"]
...
ListProtectConfigurationRuleSetNumberOverridesPaginatorName = Literal["list_protect_configuration_rule_set_number_overrides"]
...
ProtectConfigurationRuleSetNumberOverrideFilterNameType = Literal["action",
    "created-after",
    "created-before",
...
RegistrationVersionStatusType = Literal["APPROVED",
    "ARCHIVED",
    "DENIED",
    "DISCARDED",
    "DRAFT",
