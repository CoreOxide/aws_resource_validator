...
FilterFieldType = Literal["ActionName", "ApprovalTeamName", "InitiationTime", "SessionStatus", "Vote", "VotingTime"]
...
SessionStatusCodeType = Literal["ALL_APPROVERS_IN_SESSION", "CONFIGURATION_CHANGED", "EXPIRED", "REJECTED"]
