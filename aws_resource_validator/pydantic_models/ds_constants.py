...
CertificateStateType = Literal["DeregisterFailed",
    "Deregistered",
    "Deregistering",
    "RegisterFailed",
    "Registered",
...
DescribeClientAuthenticationSettingsPaginatorName = Literal["describe_client_authentication_settings"]
...
DirectoryStageType = Literal["Active",
    "Created",
    "Creating",
    "Deleted",
    "Deleting",
...
DomainControllerStatusType = Literal["Active", "Creating", "Deleted", "Deleting", "Failed", "Impaired", "Restoring"]
IpRouteStatusMsgType = Literal["AddFailed", "Added", "Adding", "RemoveFailed", "Removed", "Removing"]
...
SchemaExtensionStatusType = Literal["CancelInProgress",
    "Cancelled",
    "Completed",
    "CreatingSnapshot",
    "Failed",
...
ShareStatusType = Literal["Deleted",
    "Deleting",
    "PendingAcceptance",
    "RejectFailed",
    "Rejected",
...
TrustStateType = Literal["Created",
    "Creating",
    "Deleted",
    "Deleting",
    "Failed",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["describe_client_authentication_settings",
...
RegionName = Literal["af-south-1",
    ...
    "us-west-1",
    "us-west-2",]
DirectoryVpcSettingsUnionTypeDef = Union[   'DirectoryVpcSettingsTypeDef', 'DirectoryVpcSettingsExtraOutputTypeDef' ]
