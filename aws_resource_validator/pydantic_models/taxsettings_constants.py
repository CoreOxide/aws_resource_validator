...
MalaysiaServiceTaxCodeType = Literal["Consultancy", "Digital Service And Electronic Medium", "IT Services", "Training Or Coaching"]
PersonTypeType = Literal["Business", "Legal Person", "Physical Person"]
RegistrationTypeType = Literal["Intra-EU", "Local"]
SaudiArabiaTaxRegistrationNumberTypeType = Literal["CommercialRegistrationNumber", "TaxIdentificationNumber", "TaxRegistrationNumber"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_supplemental_tax_registrations", "list_tax_exemptions", "list_tax_registrations"]
