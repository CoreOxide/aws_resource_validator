...
AccessorNetworkTypeType = Literal["ETHEREUM_GOERLI",
    "ETHEREUM_MAINNET",
...
MemberStatusType = Literal["AVAILABLE",
    "CREATE_FAILED",
    "CREATING",
    "DELETED",
    "DELETING",
...
NodeStatusType = Literal["AVAILABLE",
    "CREATE_FAILED",
    "CREATING",
    "DELETED",
    "DELETING",
...
RegionName = Literal["ap-northeast-1", "ap-northeast-2", "ap-southeast-1", "eu-west-1", "eu-west-2", "us-east-1"]
