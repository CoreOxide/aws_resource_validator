...
BatchDeleteConfigurationTaskStatusType = Literal["COMPLETED", "DELETING", "FAILED", "INITIALIZING", "VALIDATING"]
...
FileClassificationType = Literal["IMPORT_TEMPLATE", "MODELIZEIT_EXPORT", "RVTOOLS_EXPORT", "VMWARE_NSX_EXPORT"]
...
RegionName = Literal[
    "ap-northeast-1", "ap-southeast-2", "eu-central-1", "eu-west-1", "eu-west-2", "us-east-1", "us-west-2"
]
