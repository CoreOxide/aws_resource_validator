...
DestinationCategoryType = Literal["AMAZON_DYNAMODB", "AMAZON_S3", "INTER_AZ", "INTER_VPC", "INTRA_AZ", "UNCLASSIFIED"]
GetQueryResultsMonitorTopContributorsPaginatorName = Literal["get_query_results_monitor_top_contributors"]
GetQueryResultsWorkloadInsightsTopContributorsDataPaginatorName = Literal["get_query_results_workload_insights_top_contributors_data"]
GetQueryResultsWorkloadInsightsTopContributorsPaginatorName = Literal["get_query_results_workload_insights_top_contributors"]
...
MonitorRemoteResourceTypeType = Literal["AWS::AWSService", "AWS::AvailabilityZone", "AWS::EC2::Subnet", "AWS::EC2::VPC"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["get_query_results_monitor_top_contributors",
