...
AwsLogSourceNameType = Literal["CLOUD_TRAIL_MGMT",
    "EKS_AUDIT",
    "LAMBDA_EXECUTION",
    "ROUTE53",
    "S3_DATA",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["get_data_lake_sources", "list_data_lake_exceptions", "list_log_sources", "list_subscribers"]
RegionName = Literal["ap-northeast-1",
    ...
    "us-west-1",
    "us-west-2",]
DataLakeAutoEnableNewAccountConfigurationUnionTypeDef = Union[   'DataLakeAutoEnableNewAccountConfigurationTypeDef',   'DataLakeAutoEnableNewAccountConfigurationOutputTypeDef', ]
