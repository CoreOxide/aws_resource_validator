...
AdapterVersionStatusType = Literal["ACTIVE", "AT_RISK", "CREATION_ERROR", "CREATION_IN_PROGRESS", "DEPRECATED"]
...
RelationshipTypeType = Literal[
    "ANSWER", "CHILD", "COMPLEX_FEATURES", "MERGED_CELL", "TABLE", "TABLE_FOOTER", "TABLE_TITLE", "TITLE", "VALUE"
]
