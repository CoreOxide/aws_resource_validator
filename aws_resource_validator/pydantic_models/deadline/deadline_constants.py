...
FleetStatusType = Literal[
    "ACTIVE", "CREATE_FAILED", "CREATE_IN_PROGRESS", "SUSPENDED", "UPDATE_FAILED", "UPDATE_IN_PROGRESS"
]
...
WorkerStatusType = Literal[
    "CREATED", "IDLE", "NOT_COMPATIBLE", "NOT_RESPONDING", "RUNNING", "STARTED", "STOPPED", "STOPPING"
]
