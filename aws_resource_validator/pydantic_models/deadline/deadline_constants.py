...
BudgetActionTypeType = Literal['STOP_SCHEDULING_AND_CANCEL_TASKS', 'STOP_SCHEDULING_AND_COMPLETE_TASKS']
BudgetStatusType = Literal['ACTIVE', 'INACTIVE']
ComparisonOperatorType = Literal['EQUAL', 'GREATER_THAN', 'GREATER_THAN_EQUAL_TO', 'LESS_THAN', 'LESS_THAN_EQUAL_TO', 'NOT_EQUAL']
...
DefaultQueueBudgetActionType = Literal['NONE', 'STOP_SCHEDULING_AND_CANCEL_TASKS', 'STOP_SCHEDULING_AND_COMPLETE_TASKS']
...
FleetStatusType = Literal['ACTIVE', 'CREATE_FAILED', 'CREATE_IN_PROGRESS', 'UPDATE_FAILED', 'UPDATE_IN_PROGRESS']
...
JobEntityErrorCodeType = Literal['AccessDeniedException', 'ConflictException', 'InternalServerException', 'MaxPayloadSizeExceeded', 'ResourceNotFoundException', 'ValidationException']
JobLifecycleStatusType = Literal['ARCHIVED', 'CREATE_COMPLETE', 'CREATE_FAILED', 'CREATE_IN_PROGRESS', 'UPDATE_FAILED', 'UPDATE_IN_PROGRESS', 'UPDATE_SUCCEEDED', 'UPLOAD_FAILED', 'UPLOAD_IN_PROGRESS']
JobTargetTaskRunStatusType = Literal['CANCELED', 'FAILED', 'PENDING', 'READY', 'SUCCEEDED', 'SUSPENDED']
JobTemplateTypeType = Literal['JSON', 'YAML']
LicenseEndpointDeletedWaiterName = Literal['license_endpoint_deleted']
LicenseEndpointStatusType = Literal['CREATE_IN_PROGRESS', 'DELETE_IN_PROGRESS', 'NOT_READY', 'READY']
...
PaginatorName = Literal['get_sessions_statistics_aggregation', 'list_available_metered_products', 'list_budgets', 'list_farm_members', 'list_farms', 'list_fleet_members', 'list_fleets', 'list_job_members', 'list_job_parameter_definitions', 'list_jobs', 'list_license_endpoints', 'list_limits', 'list_metered_products', 'list_monitors', 'list_queue_environments', 'list_queue_fleet_associations', 'list_queue_limit_associations', 'list_queue_members', 'list_queues', 'list_session_actions', 'list_sessions', 'list_sessions_for_worker', 'list_step_consumers', 'list_step_dependencies', 'list_steps', 'list_storage_profiles', 'list_storage_profiles_for_queue', 'list_tasks', 'list_workers']
...
QueueFleetAssociationStatusType = Literal['ACTIVE', 'STOPPED', 'STOP_SCHEDULING_AND_CANCEL_TASKS', 'STOP_SCHEDULING_AND_COMPLETE_TASKS']
QueueFleetAssociationStoppedWaiterName = Literal['queue_fleet_association_stopped']
QueueLimitAssociationStatusType = Literal['ACTIVE', 'STOPPED', 'STOP_LIMIT_USAGE_AND_CANCEL_TASKS', 'STOP_LIMIT_USAGE_AND_COMPLETE_TASKS']
...
SessionActionStatusType = Literal['ASSIGNED', 'CANCELED', 'CANCELING', 'FAILED', 'INTERRUPTED', 'NEVER_ATTEMPTED', 'RECLAIMED', 'RECLAIMING', 'RUNNING', 'SCHEDULED', 'SUCCEEDED']
SessionLifecycleStatusType = Literal['ENDED', 'STARTED', 'UPDATE_FAILED', 'UPDATE_IN_PROGRESS', 'UPDATE_SUCCEEDED']
...
StepLifecycleStatusType = Literal['CREATE_COMPLETE', 'UPDATE_FAILED', 'UPDATE_IN_PROGRESS', 'UPDATE_SUCCEEDED']
StepParameterTypeType = Literal['FLOAT', 'INT', 'PATH', 'STRING']
StepTargetTaskRunStatusType = Literal['CANCELED', 'FAILED', 'PENDING', 'READY', 'SUCCEEDED', 'SUSPENDED']
StorageProfileOperatingSystemFamilyType = Literal['LINUX', 'MACOS', 'WINDOWS']
TaskRunStatusType = Literal['ASSIGNED', 'CANCELED', 'FAILED', 'INTERRUPTING', 'NOT_COMPATIBLE', 'PENDING', 'READY', 'RUNNING', 'SCHEDULED', 'STARTING', 'SUCCEEDED', 'SUSPENDED']
TaskTargetRunStatusType = Literal['CANCELED', 'FAILED', 'PENDING', 'READY', 'SUCCEEDED', 'SUSPENDED']
UpdateJobLifecycleStatusType = Literal['ARCHIVED']
UpdateQueueFleetAssociationStatusType = Literal['ACTIVE', 'STOP_SCHEDULING_AND_CANCEL_TASKS', 'STOP_SCHEDULING_AND_COMPLETE_TASKS']
UpdateQueueLimitAssociationStatusType = Literal['ACTIVE', 'STOP_LIMIT_USAGE_AND_CANCEL_TASKS', 'STOP_LIMIT_USAGE_AND_COMPLETE_TASKS']
UpdatedWorkerStatusType = Literal['STARTED', 'STOPPED', 'STOPPING']
UsageGroupByFieldType = Literal['FLEET_ID', 'INSTANCE_TYPE', 'JOB_ID', 'LICENSE_PRODUCT', 'QUEUE_ID', 'USAGE_TYPE', 'USER_ID']
UsageStatisticType = Literal['AVG', 'MAX', 'MIN', 'SUM']
UsageTypeType = Literal['COMPUTE', 'LICENSE']
WaiterName = Literal['fleet_active', 'job_create_complete', 'license_endpoint_deleted', 'license_endpoint_valid', 'queue_fleet_association_stopped', 'queue_limit_association_stopped', 'queue_scheduling', 'queue_scheduling_blocked']
WorkerStatusType = Literal['CREATED', 'IDLE', 'NOT_COMPATIBLE', 'NOT_RESPONDING', 'RUNNING', 'STARTED', 'STOPPED', 'STOPPING']