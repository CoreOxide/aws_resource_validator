...
AlgorithmNameGeoMosaicType = Literal["AVERAGE",
    "BILINEAR",
    "CUBIC",
    "CUBICSPLINE",
    "LANCZOS",
    ...
    "RMS",
    "SUM",]
AlgorithmNameResamplingType = Literal["AVERAGE",
    "BILINEAR",
    "CUBIC",
    "CUBICSPLINE",
    "LANCZOS",
...
EarthObservationJobStatusType = Literal["COMPLETED",
    "DELETED",
    "DELETING",
    "FAILED",
    "INITIALIZING",
...
VectorEnrichmentJobStatusType = Literal["COMPLETED",
    "DELETED",
    "DELETING",
    "FAILED",
    "INITIALIZING",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_earth_observation_jobs", "list_raster_data_collections", "list_vector_enrichment_jobs"]
