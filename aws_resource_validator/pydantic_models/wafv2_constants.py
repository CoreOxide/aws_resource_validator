...
AssociatedResourceTypeType = Literal["API_GATEWAY",
    "APP_RUNNER_SERVICE",
    "CLOUDFRONT",
    "COGNITO_USER_POOL",
...
CountryCodeType = Literal["AD",
    ...
    "ZM",
    "ZW",]
FailureReasonType = Literal["TOKEN_DOMAIN_MISMATCH", "TOKEN_EXPIRED", "TOKEN_INVALID", "TOKEN_MISSING"]
...
PositionalConstraintType = Literal["CONTAINS", "CONTAINS_WORD", "ENDS_WITH", "EXACTLY", "STARTS_WITH"]
RateBasedStatementAggregateKeyTypeType = Literal["CONSTANT", "CUSTOM_KEYS", "FORWARDED_IP", "IP"]
ResourceTypeType = Literal["API_GATEWAY",
...
TextTransformationTypeType = Literal["BASE64_DECODE",
    "BASE64_DECODE_EXT",
    "CMD_LINE",
...
LoggingConfigurationUnionTypeDef = Union[   'LoggingConfigurationTypeDef', 'LoggingConfigurationOutputTypeDef' ]
