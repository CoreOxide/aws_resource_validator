...
class DistributeDatasetEntriesRequest(BaseValidatorModel):
    Datasets: Sequence[DistributeDataset]
...
class StreamProcessorSettingsUnion(BaseValidatorModel):
    pass


class RegionOfInterestUnion(BaseValidatorModel):
    pass
...
class CreateStreamProcessorRequest(BaseValidatorModel):
    ...
    KmsKeyId: Optional[str] = None
    RegionsOfInterest: Optional[Sequence[RegionOfInterestUnion]] = None
...
class UpdateStreamProcessorRequest(BaseValidatorModel):
    ...
    RegionsOfInterestForUpdate: Optional[Sequence[RegionOfInterestUnion]] = None
...
class TrainingDataUnion(BaseValidatorModel):
    pass


class TestingDataUnion(BaseValidatorModel):
    pass
