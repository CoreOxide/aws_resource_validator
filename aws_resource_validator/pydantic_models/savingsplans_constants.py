...
SavingsPlanRateFilterAttributeType = Literal["instanceFamily", "instanceType", "productDescription", "productId", "region", "tenancy"]
SavingsPlanRateFilterNameType = Literal["instanceType",
    ...
    "tenancy",
    "usageType",]
SavingsPlanRatePropertyKeyType = Literal["instanceFamily", "instanceType", "productDescription", "region", "tenancy"]
SavingsPlanRateServiceCodeType = Literal["AWSLambda", "AmazonEC2", "AmazonECS", "AmazonEKS", "AmazonSageMaker"]
SavingsPlanRateUnitType = Literal["Hrs", "Lambda-GB-Second", "Request"]
SavingsPlanStateType = Literal["active",
    "payment-failed",
    "payment-pending",
    "pending-return",
    "queued",
...
SavingsPlansFilterNameType = Literal["commitment",
    "ec2-instance-family",
    "end",
    "payment-option",
    "region",
