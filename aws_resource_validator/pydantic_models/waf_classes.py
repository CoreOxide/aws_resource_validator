...
class ActivatedRuleExtraOutputTypeDef(BaseModel):
    Priority: int
    RuleId: str
...
class ActivatedRuleOutputTypeDef(BaseModel):
    Priority: int
    RuleId: str
    Action: Optional[WafActionTypeDef] = None
    OverrideAction: Optional[WafOverrideActionTypeDef] = None
...
class ByteMatchTupleOutputTypeDef(BaseModel):
...
class LoggingConfigurationExtraOutputTypeDef(BaseModel):
    ResourceArn: str
...
class GetRateBasedRuleManagedKeysRequestGetRateBasedRuleManagedKeysPaginateTypeDef(BaseModel):
    RuleId: str
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListActivatedRulesInRuleGroupRequestListActivatedRulesInRuleGroupPaginateTypeDef(BaseModel):
    RuleGroupId: Optional[str] = None
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListByteMatchSetsRequestListByteMatchSetsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListGeoMatchSetsRequestListGeoMatchSetsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListIPSetsRequestListIPSetsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListLoggingConfigurationsRequestListLoggingConfigurationsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListRateBasedRulesRequestListRateBasedRulesPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListRegexMatchSetsRequestListRegexMatchSetsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListRegexPatternSetsRequestListRegexPatternSetsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None
...
class ListSizeConstraintSetsRequestListSizeConstraintSetsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListSqlInjectionMatchSetsRequestListSqlInjectionMatchSetsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListSubscribedRuleGroupsRequestListSubscribedRuleGroupsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListWebACLsRequestListWebACLsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None

class ListXssMatchSetsRequestListXssMatchSetsPaginateTypeDef(BaseModel):
    PaginationConfig: Optional[PaginatorConfigTypeDef] = None
