...
MachineLearningProductSortByType = Literal["EntityId", "LastModifiedDate", "ProductTitle", "Visibility"]
MachineLearningProductVisibilityStringType = Literal["Draft", "Limited", "Public", "Restricted"]
OfferSetSortByType = Literal["EntityId", "LastModifiedDate", "Name", "ReleaseDate", "SolutionId", "State"]
...
SaaSProductSortByType = Literal["DeliveryOptionTypes", "EntityId", "LastModifiedDate", "ProductTitle", "Visibility"]
