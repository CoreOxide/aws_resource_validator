...
BatchCreateBillScenarioCommitmentModificationErrorCodeType = Literal["CONFLICT", "INTERNAL_SERVER_ERROR", "INVALID_ACCOUNT"]
BatchCreateBillScenarioUsageModificationErrorCodeType = Literal["BAD_REQUEST", "CONFLICT", "INTERNAL_SERVER_ERROR", "NOT_FOUND"]
...
BatchUpdateBillScenarioCommitmentModificationErrorCodeType = Literal["BAD_REQUEST", "CONFLICT", "INTERNAL_SERVER_ERROR", "NOT_FOUND"]
BatchUpdateBillScenarioUsageModificationErrorCodeType = Literal["BAD_REQUEST", "CONFLICT", "INTERNAL_SERVER_ERROR", "NOT_FOUND"]
...
ListBillEstimateLineItemsFilterNameType = Literal["LINE_ITEM_TYPE", "LOCATION", "OPERATION", "SERVICE_CODE", "USAGE_ACCOUNT_ID", "USAGE_TYPE"]
...
ListUsageFilterNameType = Literal["HISTORICAL_LOCATION",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_bill_estimate_commitments",
