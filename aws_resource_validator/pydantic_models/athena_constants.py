...
CalculationExecutionStateType = Literal["CANCELED", "CANCELING", "COMPLETED", "CREATED", "CREATING", "FAILED", "QUEUED", "RUNNING"]
CapacityAllocationStatusType = Literal["FAILED", "PENDING", "SUCCEEDED"]
CapacityReservationStatusType = Literal["ACTIVE", "CANCELLED", "CANCELLING", "FAILED", "PENDING", "UPDATE_PENDING"]
...
ExecutorStateType = Literal["CREATED", "CREATING", "FAILED", "REGISTERED", "TERMINATED", "TERMINATING"]
...
SessionStateType = Literal["BUSY", "CREATED", "CREATING", "DEGRADED", "FAILED", "IDLE", "TERMINATED", "TERMINATING"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["get_query_results",
    "list_data_catalogs",
    "list_databases",
    "list_named_queries",
...
EngineConfigurationUnionTypeDef = Union[   'EngineConfigurationTypeDef', 'EngineConfigurationOutputTypeDef' ]
