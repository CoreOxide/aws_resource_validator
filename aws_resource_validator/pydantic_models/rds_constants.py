...
ClientPasswordAuthTypeType = Literal["MYSQL_NATIVE_PASSWORD", "POSTGRES_MD5", "POSTGRES_SCRAM_SHA_256", "SQL_SERVER_AUTHENTICATION"]
...
DBProxyEndpointStatusType = Literal["available",
    "creating",
    "deleting",
...
DBProxyStatusType = Literal["available",
    "creating",
    "deleting",
    "incompatible-network",
    "insufficient-resource-limits",
...
LimitlessDatabaseStatusType = Literal["active",
    "disabled",
    "disabling",
    "enabled",
    "enabling",
...
SourceTypeType = Literal["blue-green-deployment",
    ...
    "db-security-group",
    "db-snapshot",]
TargetHealthReasonType = Literal["AUTH_FAILURE",
    "CONNECTION_FAILED",
