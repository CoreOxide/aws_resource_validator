...
AuditEventTypeType = Literal[
    "Case.Created", "Case.Updated", "RelatedItem.Created", "RelatedItem.Deleted", "RelatedItem.Updated"
]
...
PaginatorName = Literal["list_case_rules", "search_all_related_items", "search_cases", "search_related_items"]
RegionName = Literal[
    "af-south-1",
    "ap-northeast-1",
    "ap-northeast-2",
