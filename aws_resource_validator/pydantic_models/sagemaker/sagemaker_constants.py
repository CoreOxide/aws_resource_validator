...
AutoMLProblemTypeConfigNameType = Literal[
    "ImageClassification", "Tabular", "TextClassification", "TextGeneration", "TimeSeriesForecasting"
]
...
BatchAddClusterNodesErrorCodeType = Literal[
    "IncompatibleAvailabilityZones", "IncompatibleInstanceTypes", "InstanceGroupNotFound", "InvalidInstanceGroupStatus"
]
...
DescribeTrainingPlanExtensionHistoryPaginatorName = Literal["describe_training_plan_extension_history"]
...
HubContentStatusType = Literal[
    "Available", "DeleteFailed", "Deleting", "ImportFailed", "Importing", "PendingDelete", "PendingImport"
]
...
MlflowAppStatusType = Literal[
    "CreateFailed", "Created", "Creating", "DeleteFailed", "Deleted", "Deleting", "UpdateFailed", "Updated", "Updating"
]
...
ModelCardProcessingStatusType = Literal[
    "ContentDeleted", "DeleteCompleted", "DeleteFailed", "DeleteInProgress", "DeletePending", "ExportJobsDeleted"
]
...
StageStatusType = Literal[
    "CREATING", "DEPLOYED", "FAILED", "INPROGRESS", "READYTODEPLOY", "STARTING", "STOPPED", "STOPPING"
]
...
TrackingServerMaintenanceStatusType = Literal["MaintenanceComplete", "MaintenanceFailed", "MaintenanceInProgress"]
...
TrainingJobStatusType = Literal["Completed", "Deleting", "Failed", "InProgress", "Stopped", "Stopping"]
