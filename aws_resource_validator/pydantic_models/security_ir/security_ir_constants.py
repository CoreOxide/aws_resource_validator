...
ExecutionStatusType = Literal["Cancelled", "Completed", "Failed", "InProgress", "Pending", "Waiting"]
...
SelfManagedCaseStatusType = Literal[
    "Containment, Eradication and Recovery", "Detection and Analysis", "Post-incident Activities", "Submitted"
]
...
PaginatorName = Literal["list_case_edits", "list_cases", "list_comments", "list_investigations", "list_memberships"]
