...
PaginatorName = Literal['list_addon_instances', 'list_addon_subscriptions', 'list_address_list_import_jobs', 'list_address_lists', 'list_archive_exports', 'list_archive_searches', 'list_archives', 'list_ingress_points', 'list_members_of_address_list', 'list_relays', 'list_rule_sets', 'list_traffic_policies']
ResourceServiceName = Literal['cloudformation', 'cloudwatch', 'dynamodb', 'ec2', 'glacier', 'iam', 'opsworks', 's3', 'sns', 'sqs']
RetentionPeriodType = Literal['EIGHTEEN_MONTHS', 'EIGHT_YEARS', 'FIVE_YEARS', 'FOUR_YEARS', 'NINE_MONTHS', 'NINE_YEARS', 'ONE_YEAR', 'PERMANENT', 'SEVEN_YEARS', 'SIX_MONTHS', 'SIX_YEARS', 'TEN_YEARS', 'THIRTY_MONTHS', 'THREE_MONTHS', 'THREE_YEARS', 'TWO_YEARS']
...
RuleNumberOperatorType = Literal['EQUALS', 'GREATER_THAN', 'GREATER_THAN_OR_EQUAL', 'LESS_THAN', 'LESS_THAN_OR_EQUAL', 'NOT_EQUALS']
