...
IndicatorTypeType = Literal["FLAGGED_IP_ADDRESS",
    "IMPOSSIBLE_TRAVEL",
    "NEW_ASO",
    "NEW_GEOLOCATION",
    "NEW_USER_AGENT",
...
MemberStatusType = Literal["ACCEPTED_BUT_DISABLED", "ENABLED", "INVITED", "VERIFICATION_FAILED", "VERIFICATION_IN_PROGRESS"]
