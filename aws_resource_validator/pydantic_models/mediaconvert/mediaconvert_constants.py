...
Ac3CodingModeType = Literal[
    "CODING_MODE_1_0", "CODING_MODE_1_1", "CODING_MODE_2_0", "CODING_MODE_3_2_LFE", "CODING_MODE_AUTO"
]
...
AudioCodecType = Literal[
    "AAC", "AC3", "AC4", "AIFF", "EAC3", "EAC3_ATMOS", "FLAC", "MP2", "MP3", "OPUS", "PASSTHROUGH", "VORBIS", "WAV"
]
...
AudioSelectorTypeType = Literal["ALL_PCM", "HLS_RENDITION_GROUP", "LANGUAGE_CODE", "PID", "STREAM", "TRACK"]
...
Eac3CodingModeType = Literal["CODING_MODE_1_0", "CODING_MODE_2_0", "CODING_MODE_3_2", "CODING_MODE_AUTO"]
...
ElementalInferenceFeedManagementStateType = Literal["ASSOCIATED", "CREATED", "DELETED", "PENDING_DELETION"]
...
JobsQueryFilterKeyType = Literal[
    "audioCodec", "fileInput", "jobEngineVersionRequested", "jobEngineVersionUsed", "queue", "status", "videoCodec"
]
...
S3StorageClassType = Literal[
    "DEEP_ARCHIVE", "GLACIER", "INTELLIGENT_TIERING", "ONEZONE_IA", "REDUCED_REDUNDANCY", "STANDARD", "STANDARD_IA"
]
SampleRangeConversionType = Literal["LIMITED_RANGE_CLIP", "LIMITED_RANGE_SQUEEZE", "NONE"]
ScalingBehaviorType = Literal["DEFAULT", "FILL", "FIT", "FIT_NO_UPSCALE", "SMART_CROP", "STRETCH_TO_OUTPUT"]
