...
GroupFilterNameType = Literal["configuration-type", "criticality", "display-name", "owner", "resource-type"]
...
PaginatorName = Literal[
    "list_group_resources", "list_grouping_statuses", "list_groups", "list_tag_sync_tasks", "search_resources"
]
RegionName = Literal[
    "af-south-1",
    "ap-east-1",
