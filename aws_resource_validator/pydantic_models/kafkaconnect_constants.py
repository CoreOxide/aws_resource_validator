...
ConnectorOperationStateType = Literal["PENDING",
    "ROLLBACK_COMPLETE",
    "ROLLBACK_FAILED",
...
ConnectorOperationStepTypeType = Literal["FINALIZE_UPDATE",
    "INITIALIZE_UPDATE",
    "UPDATE_CONNECTOR_CONFIGURATION",
    "UPDATE_WORKER_SETTING",
    "VALIDATE_UPDATE",]
ConnectorOperationTypeType = Literal["ISOLATE_CONNECTOR",
    "RESTORE_CONNECTOR",
    "UPDATE_CONNECTOR_CONFIGURATION",
    "UPDATE_WORKER_SETTING",]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_connector_operations",
    "list_connectors",
    "list_custom_plugins",
