...
ClusterStateChangeReasonCodeType = Literal['ALL_STEPS_COMPLETED', 'BOOTSTRAP_FAILURE', 'INSTANCE_FAILURE', 'INSTANCE_FLEET_TIMEOUT', 'INTERNAL_ERROR', 'STEP_FAILURE', 'USER_REQUEST', 'VALIDATION_ERROR']
ClusterStateType = Literal['BOOTSTRAPPING', 'RUNNING', 'STARTING', 'TERMINATED', 'TERMINATED_WITH_ERRORS', 'TERMINATING', 'WAITING']
...
InstanceGroupStateType = Literal['ARRESTED', 'BOOTSTRAPPING', 'ENDED', 'PROVISIONING', 'RECONFIGURING', 'RESIZING', 'RUNNING', 'SHUTTING_DOWN', 'SUSPENDED', 'TERMINATED', 'TERMINATING']
InstanceGroupTypeType = Literal['CORE', 'MASTER', 'TASK']
InstanceRoleTypeType = Literal['CORE', 'MASTER', 'TASK']
InstanceStateChangeReasonCodeType = Literal['BOOTSTRAP_FAILURE', 'CLUSTER_TERMINATED', 'INSTANCE_FAILURE', 'INTERNAL_ERROR', 'VALIDATION_ERROR']
InstanceStateType = Literal['AWAITING_FULFILLMENT', 'BOOTSTRAPPING', 'PROVISIONING', 'RUNNING', 'TERMINATED']
JobFlowExecutionStateType = Literal['BOOTSTRAPPING', 'COMPLETED', 'FAILED', 'RUNNING', 'SHUTTING_DOWN', 'STARTING', 'TERMINATED', 'WAITING']
...
NotebookExecutionStatusType = Literal['FAILED', 'FAILING', 'FINISHED', 'FINISHING', 'RUNNING', 'STARTING', 'START_PENDING', 'STOPPED', 'STOPPING', 'STOP_PENDING']
...
PaginatorName = Literal['list_bootstrap_actions', 'list_clusters', 'list_instance_fleets', 'list_instance_groups', 'list_instances', 'list_notebook_executions', 'list_security_configurations', 'list_steps', 'list_studio_session_mappings', 'list_studios']
...
SpotProvisioningAllocationStrategyType = Literal['capacity-optimized', 'capacity-optimized-prioritized', 'diversified', 'lowest-price', 'price-capacity-optimized']
