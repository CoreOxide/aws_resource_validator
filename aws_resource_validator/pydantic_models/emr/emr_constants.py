...
InstanceFleetStateType = Literal[
    "BOOTSTRAPPING", "PROVISIONING", "RECONFIGURING", "RESIZING", "RUNNING", "SUSPENDED", "TERMINATED", "TERMINATING"
]
...
OnClusterAppUITypeType = Literal[
    "ApplicationMaster", "JobHistoryServer", "ResourceManager", "SparkHistoryServer", "TezUI", "YarnTimelineService"
]
