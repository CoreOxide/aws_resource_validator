...
ForecastDataTypeType = Literal["CapacityForecast", "LoadForecast", "ScheduledActionMaxCapacity", "ScheduledActionMinCapacity"]
LoadMetricTypeType = Literal["ALBTargetGroupRequestCount",
    "ASGTotalCPUUtilization",
    "ASGTotalNetworkIn",
    "ASGTotalNetworkOut",]
MetricStatisticType = Literal["Average", "Maximum", "Minimum", "SampleCount", "Sum"]
PolicyTypeType = Literal["TargetTrackingScaling"]
PredictiveScalingMaxCapacityBehaviorType = Literal["SetForecastCapacityToMaxCapacity",
    "SetMaxCapacityAboveForecastCapacity",
    "SetMaxCapacityToForecastCapacity",]
PredictiveScalingModeType = Literal["ForecastAndScale", "ForecastOnly"]
ScalableDimensionType = Literal["autoscaling:autoScalingGroup:DesiredCapacity",
...
ScalingMetricTypeType = Literal["ALBRequestCountPerTarget",
...
ScalingPlanStatusCodeType = Literal["Active",
    "ActiveWithProblems",
    "CreationFailed",
    "CreationInProgress",
    "DeletionFailed",
