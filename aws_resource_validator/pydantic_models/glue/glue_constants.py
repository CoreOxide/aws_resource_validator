...
AggFunctionType = Literal['avg', 'count', 'countDistinct', 'first', 'kurtosis', 'last', 'max', 'min', 'skewness', 'stddev_pop', 'stddev_samp', 'sum', 'sumDistinct', 'var_pop', 'var_samp']
AuthenticationTypeType = Literal['BASIC', 'CUSTOM', 'IAM', 'OAUTH2']
BackfillErrorCodeType = Literal['ENCRYPTED_PARTITION_ERROR', 'INTERNAL_ERROR', 'INVALID_PARTITION_TYPE_DATA_ERROR', 'MISSING_PARTITION_VALUE_ERROR', 'UNSUPPORTED_PARTITION_CHARACTER_ERROR']
...
FieldDataTypeType = Literal['ARRAY', 'BIGINT', 'BOOLEAN', 'BYTE', 'DATE', 'DECIMAL', 'DOUBLE', 'FLOAT', 'INT', 'LONG', 'MAP', 'SHORT', 'SMALLINT', 'STRING', 'STRUCT', 'TIMESTAMP']
FieldFilterOperatorType = Literal['BETWEEN', 'CONTAINS', 'EQUAL_TO', 'GREATER_THAN', 'GREATER_THAN_OR_EQUAL_TO', 'LESS_THAN', 'LESS_THAN_OR_EQUAL_TO', 'NOT_EQUAL_TO', 'ORDER_BY']
...
JobRunStateType = Literal['ERROR', 'EXPIRED', 'FAILED', 'RUNNING', 'STARTING', 'STOPPED', 'STOPPING', 'SUCCEEDED', 'TIMEOUT', 'WAITING']
...
PaginatorName = Literal['describe_entity', 'get_classifiers', 'get_connections', 'get_crawler_metrics', 'get_crawlers', 'get_databases', 'get_dev_endpoints', 'get_job_runs', 'get_jobs', 'get_partition_indexes', 'get_partitions', 'get_resource_policies', 'get_security_configurations', 'get_table_versions', 'get_tables', 'get_triggers', 'get_user_defined_functions', 'get_workflow_runs', 'list_blueprints', 'list_connection_types', 'list_entities', 'list_jobs', 'list_registries', 'list_schema_versions', 'list_schemas', 'list_table_optimizer_runs', 'list_triggers', 'list_usage_profiles', 'list_workflows']
...
PermissionType = Literal['ALL', 'ALTER', 'CREATE_DATABASE', 'CREATE_TABLE', 'DATA_LOCATION_ACCESS', 'DELETE', 'DROP', 'INSERT', 'SELECT']
...
TriggerStateType = Literal['ACTIVATED', 'ACTIVATING', 'CREATED', 'CREATING', 'DEACTIVATED', 'DEACTIVATING', 'DELETING', 'UPDATING']
