...
AdditionalOptionKeysType = Literal["compositeRuleEvaluation.method", "observations.scope", "performanceTuning.caching"]
...
JobRunStateType = Literal[
    "ERROR", "EXPIRED", "FAILED", "RUNNING", "STARTING", "STOPPED", "STOPPING", "SUCCEEDED", "TIMEOUT", "WAITING"
]
...
ListMaterializedViewRefreshTaskRunsPaginatorName = Literal["list_materialized_view_refresh_task_runs"]
...
ParquetCompressionTypeType = Literal["brotli", "gzip", "lz4", "lzo", "none", "snappy", "uncompressed"]
...
PiiTypeType = Literal[
    "ColumnAudit", "ColumnHashing", "ColumnMasking", "RowAudit", "RowHashing", "RowMasking", "RowPartialMasking"
]
...
TargetFormatType = Literal["avro", "csv", "delta", "hudi", "hyper", "iceberg", "json", "orc", "parquet", "xml"]
...
TriggerStateType = Literal[
    "ACTIVATED", "ACTIVATING", "CREATED", "CREATING", "DEACTIVATED", "DEACTIVATING", "DELETING", "UPDATING"
]
