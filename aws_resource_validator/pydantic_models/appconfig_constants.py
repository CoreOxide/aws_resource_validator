...
ActionPointType = Literal["AT_DEPLOYMENT_TICK",
...
DeploymentEventTypeType = Literal["BAKE_TIME_STARTED",
    ...
    "ROLLBACK_COMPLETED",
    "ROLLBACK_STARTED",]
DeploymentStateType = Literal["BAKING", "COMPLETE", "DEPLOYING", "REVERTED", "ROLLED_BACK", "ROLLING_BACK", "VALIDATING"]
EnvironmentStateType = Literal["DEPLOYING", "READY_FOR_DEPLOYMENT", "REVERTED", "ROLLED_BACK", "ROLLING_BACK"]
