...
ComparatorType = Literal["DoesNotExist",
    "EqualTo",
    "Exists",
    "GreaterThan",
    ...
    "NotEqualTo",
    "NotIn",]
EventTypeType = Literal["AssignmentAbandoned",
    "AssignmentAccepted",
    "AssignmentApproved",
    "AssignmentRejected",
    "AssignmentReturned",
...
HITReviewStatusType = Literal["MarkedForReview", "NotReviewed", "ReviewedAppropriate", "ReviewedInappropriate"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_assignments_for_hit",
    "list_bonus_payments",
    "list_hits",
