...
EnvironmentSoftwareSetComplianceStatusType = Literal["COMPLIANT", "NOT_COMPLIANT", "NO_REGISTERED_DEVICES"]
...
RegionName = Literal["ap-south-1", "ca-central-1", "eu-central-1", "eu-west-1", "eu-west-2", "us-east-1", "us-west-2"]
