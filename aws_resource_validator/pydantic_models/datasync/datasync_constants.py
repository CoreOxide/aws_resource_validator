...
OperatorType = Literal['BeginsWith', 'Contains', 'Equals', 'GreaterThan', 'GreaterThanOrEqual', 'In', 'LessThan', 'LessThanOrEqual', 'NotContains', 'NotEquals']
OverwriteModeType = Literal['ALWAYS', 'NEVER']
PaginatorName = Literal['describe_storage_system_resource_metrics', 'list_agents', 'list_discovery_jobs', 'list_locations', 'list_storage_systems', 'list_tags_for_resource', 'list_task_executions', 'list_tasks']
...
S3StorageClassType = Literal['DEEP_ARCHIVE', 'GLACIER', 'GLACIER_INSTANT_RETRIEVAL', 'INTELLIGENT_TIERING', 'ONEZONE_IA', 'OUTPOSTS', 'STANDARD', 'STANDARD_IA']
...
TaskExecutionStatusType = Literal['CANCELLING', 'ERROR', 'LAUNCHING', 'PREPARING', 'QUEUED', 'SUCCESS', 'TRANSFERRING', 'VERIFYING']
