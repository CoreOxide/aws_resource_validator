...
StreamGroupStatusType = Literal[
    "ACTIVATING", "ACTIVE", "ACTIVE_WITH_ERRORS", "DELETING", "ERROR", "EXPIRED", "UPDATING_LOCATIONS"
]
...
PaginatorName = Literal[
    "list_applications", "list_stream_groups", "list_stream_sessions", "list_stream_sessions_by_account"
]
WaiterName = Literal[
    "application_deleted", "application_ready", "stream_group_active", "stream_group_deleted", "stream_session_active"
]
RegionName = Literal[
    "af-south-1",
    "ap-east-1",
