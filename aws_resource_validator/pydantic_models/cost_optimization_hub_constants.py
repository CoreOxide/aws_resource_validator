...
ActionTypeType = Literal["MigrateToGraviton",
...
ResourceTypeType = Literal["ComputeSavingsPlans",
    "EbsVolume",
    "Ec2AutoScalingGroup",
    "Ec2Instance",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_enrollment_statuses", "list_recommendation_summaries", "list_recommendations"]
