...
BatchPutAssetPropertyValueErrorCodeType = Literal['AccessDeniedException', 'ConflictingOperationException', 'InternalFailureException', 'InvalidRequestException', 'LimitExceededException', 'ResourceNotFoundException', 'ServiceUnavailableException', 'ThrottlingException', 'TimestampOutOfRangeException']
CapabilitySyncStatusType = Literal['IN_SYNC', 'NOT_APPLICABLE', 'OUT_OF_SYNC', 'SYNC_FAILED', 'UNKNOWN']
ColumnNameType = Literal['ALIAS', 'ASSET_ID', 'DATA_TYPE', 'PROPERTY_ID', 'QUALITY', 'TIMESTAMP_NANO_OFFSET', 'TIMESTAMP_SECONDS', 'VALUE']
...
PaginatorName = Literal['execute_query', 'get_asset_property_aggregates', 'get_asset_property_value_history', 'get_interpolated_asset_property_values', 'list_access_policies', 'list_actions', 'list_asset_model_composite_models', 'list_asset_model_properties', 'list_asset_models', 'list_asset_properties', 'list_asset_relationships', 'list_assets', 'list_associated_assets', 'list_bulk_import_jobs', 'list_composition_relationships', 'list_dashboards', 'list_datasets', 'list_gateways', 'list_portals', 'list_project_assets', 'list_projects', 'list_time_series']
...
RegionName = Literal['ap-northeast-1', 'ap-northeast-2', 'ap-south-1', 'ap-southeast-1', 'ap-southeast-2', 'ca-central-1', 'eu-central-1', 'eu-west-1', 'us-east-1', 'us-east-2', 'us-west-2']
...
WaiterName = Literal['asset_active', 'asset_model_active', 'asset_model_not_exists', 'asset_not_exists', 'portal_active', 'portal_not_exists']
