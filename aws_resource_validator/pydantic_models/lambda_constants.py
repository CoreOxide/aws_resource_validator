...
LastUpdateStatusReasonCodeType = Literal["DisabledKMSKey",
    "EFSIOError",
...
SourceAccessTypeType = Literal["BASIC_AUTH",
    ...
    "VPC_SECURITY_GROUP",
    "VPC_SUBNET",]
StateReasonCodeType = Literal["Creating",
    "DisabledKMSKey",
    "EFSIOError",
    "EFSMountConnectivityError",
    "EFSMountFailure",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_aliases",
...
WaiterName = Literal["function_active",
    "function_active_v2",
    "function_exists",
    "function_updated",
    "function_updated_v2",
