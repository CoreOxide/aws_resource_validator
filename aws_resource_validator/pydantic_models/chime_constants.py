...
PhoneNumberAssociationNameType = Literal["AccountId", "SipRuleId", "UserId", "VoiceConnectorGroupId", "VoiceConnectorId"]
PhoneNumberOrderStatusType = Literal["Failed", "Partial", "Processing", "Successful"]
PhoneNumberProductTypeType = Literal["BusinessCalling", "SipMediaApplicationDialIn", "VoiceConnector"]
...
TranscribeLanguageCodeType = Literal["de-DE",
    "en-AU",
    "en-GB",
    "en-US",
    "es-US",
...
TranscribeMedicalRegionType = Literal["ap-southeast-2", "auto", "ca-central-1", "eu-west-1", "us-east-1", "us-east-2", "us-west-2"]
TranscribeMedicalSpecialtyType = Literal["CARDIOLOGY", "NEUROLOGY", "ONCOLOGY", "PRIMARYCARE", "RADIOLOGY", "UROLOGY"]
TranscribeMedicalTypeType = Literal["CONVERSATION", "DICTATION"]
TranscribePartialResultsStabilityType = Literal["high", "low", "medium"]
TranscribeRegionType = Literal["ap-northeast-1",
    "ap-northeast-2",
    "ap-southeast-2",
    "auto",
    "ca-central-1",
