...
ProductTypeType = Literal["CLOUD_FORMATION_TEMPLATE",
    "EXTERNAL",
    "MARKETPLACE",
    "TERRAFORM_CLOUD",
...
ProvisionedProductPlanStatusType = Literal["CREATE_FAILED",
    "CREATE_IN_PROGRESS",
    "CREATE_SUCCESS",
    "EXECUTE_FAILED",
    "EXECUTE_IN_PROGRESS",
...
ProvisioningArtifactTypeType = Literal["CLOUD_FORMATION_TEMPLATE",
    "EXTERNAL",
    "MARKETPLACE_AMI",
    "MARKETPLACE_CAR",
    "TERRAFORM_CLOUD",
...
ServiceActionAssociationErrorCodeType = Literal["DUPLICATE_RESOURCE",
    "INTERNAL_FAILURE",
    "INVALID_PARAMETER",
    "LIMIT_EXCEEDED",
    "RESOURCE_NOT_FOUND",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_accepted_portfolio_shares",
