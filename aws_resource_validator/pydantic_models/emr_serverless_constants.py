...
JobRunStateType = Literal["CANCELLED", "CANCELLING", "FAILED", "PENDING", "RUNNING", "SCHEDULED", "SUBMITTED", "SUCCESS"]
...
MonitoringConfigurationUnionTypeDef = Union[   'MonitoringConfigurationTypeDef', 'MonitoringConfigurationOutputTypeDef' ]
