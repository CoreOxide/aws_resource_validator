...
IntegrationTypeType = Literal["RECEIVE_FINDINGS_FROM_SECURITY_HUB",
...
MalwareTypeType = Literal["ADWARE",
    "BLENDED_THREAT",
    "BOTNET_AGENT",
    "COIN_MINER",
    "EXPLOIT_KIT",
...
ThreatIntelIndicatorTypeType = Literal["DOMAIN",
    "EMAIL_ADDRESS",
    "HASH_MD5",
    "HASH_SHA1",
    "HASH_SHA256",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["describe_action_targets",
    "describe_products",
    "describe_standards",
...
ParameterConfigurationUnionTypeDef = Union[   'ParameterConfigurationTypeDef', 'ParameterConfigurationOutputTypeDef' ]
AutomationRulesActionUnionTypeDef = Union[   'AutomationRulesActionTypeDef', 'AutomationRulesActionOutputTypeDef' ]
AutomationRulesFindingFiltersUnionTypeDef = Union[   'AutomationRulesFindingFiltersTypeDef', 'AutomationRulesFindingFiltersOutputTypeDef' ]
AwsSecurityFindingFiltersUnionTypeDef = Union[   'AwsSecurityFindingFiltersTypeDef', 'AwsSecurityFindingFiltersExtraOutputTypeDef' ]
PolicyUnionTypeDef = Union['PolicyTypeDef', 'PolicyOutputTypeDef']
AwsSecurityFindingUnionTypeDef = Union[   'AwsSecurityFindingTypeDef', 'AwsSecurityFindingExtraOutputTypeDef' ]
