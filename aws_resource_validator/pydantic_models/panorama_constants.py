...
ApplicationInstanceStatusType = Literal["DEPLOYMENT_ERROR",
    "DEPLOYMENT_FAILED",
...
DeviceAggregatedStatusType = Literal["AWAITING_PROVISIONING",
    "DELETING",
    "ERROR",
    "FAILED",
    "LEASE_EXPIRED",
...
DeviceConnectionStatusType = Literal["AWAITING_CREDENTIALS", "ERROR", "NOT_AVAILABLE", "OFFLINE", "ONLINE"]
DeviceReportedStatusType = Literal["INSTALL_ERROR",
    "INSTALL_IN_PROGRESS",
    "LAUNCHED",
    "LAUNCH_ERROR",
    "REMOVAL_FAILED",
    ...
    "STOPPING",
    "STOP_ERROR",]
DeviceStatusType = Literal["AWAITING_PROVISIONING", "DELETING", "ERROR", "FAILED", "PENDING", "SUCCEEDED"]
...
StatusFilterType = Literal["DEPLOYMENT_ERROR",
    "DEPLOYMENT_FAILED",
    "DEPLOYMENT_SUCCEEDED",
...
UpdateProgressType = Literal["COMPLETED", "DOWNLOADING", "FAILED", "IN_PROGRESS", "PENDING", "REBOOTING", "VERIFYING"]
