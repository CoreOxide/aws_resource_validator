...
ActiveDirectoryStatusType = Literal["ACCESS_DENIED", "DETACHED", "JOINED", "JOINING", "NETWORK_ERROR", "TIMEOUT", "UNKNOWN_ERROR"]
...
ObjectACLType = Literal["authenticated-read",
    "aws-exec-read",
...
SMBSecurityStrategyType = Literal["ClientSpecified", "MandatoryEncryption", "MandatoryEncryptionNoAes128", "MandatorySigning"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["describe_tape_archives",
...
RegionName = Literal["af-south-1",
    ...
    "us-west-1",
    "us-west-2",]
BandwidthRateLimitIntervalUnionTypeDef = Union[   'BandwidthRateLimitIntervalTypeDef', 'BandwidthRateLimitIntervalOutputTypeDef' ]
EndpointNetworkConfigurationUnionTypeDef = Union[   'EndpointNetworkConfigurationTypeDef', 'EndpointNetworkConfigurationOutputTypeDef' ]
