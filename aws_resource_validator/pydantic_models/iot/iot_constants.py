...
CommandParameterTypeType = Literal["BINARY", "BOOLEAN", "DOUBLE", "INTEGER", "LONG", "STRING", "UNSIGNEDLONG"]
...
OTAUpdateStatusType = Literal[
    "CREATE_COMPLETE", "CREATE_FAILED", "CREATE_IN_PROGRESS", "CREATE_PENDING", "DELETE_FAILED", "DELETE_IN_PROGRESS"
]
