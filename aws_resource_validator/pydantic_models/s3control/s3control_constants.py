...
ListAccessPointsForDirectoryBucketsPaginatorName = Literal["list_access_points_for_directory_buckets"]
...
PaginatorName = Literal[
    "list_access_points_for_directory_buckets", "list_access_points_for_object_lambda", "list_caller_access_grants"
]
RegionName = Literal[
    "af-south-1",
    "ap-east-1",
