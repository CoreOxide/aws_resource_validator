...
DialogActionTypeType = Literal["Close", "ConfirmIntent", "Delegate", "ElicitIntent", "ElicitSlot", "None"]
...
PlaybackInterruptionReasonType = Literal["DTMF_START_DETECTED", "TEXT_DETECTED", "VOICE_START_DETECTED"]
