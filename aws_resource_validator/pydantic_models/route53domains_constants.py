...
CountryCodeType = Literal["AC",
    ...
    "ZM",
    "ZW",]
DomainAvailabilityType = Literal["AVAILABLE",
    "AVAILABLE_PREORDER",
    "AVAILABLE_RESERVED",
    "DONT_KNOW",
...
ExtraParamNameType = Literal["AU_ID_NUMBER",
    "AU_ID_TYPE",
    "AU_PRIORITY_TOKEN",
    "BIRTH_CITY",
    "BIRTH_COUNTRY",
...
OperationTypeType = Literal["ADD_DNSSEC",
    "CHANGE_DOMAIN_OWNER",
...
StatusFlagType = Literal["PENDING_ACCEPTANCE",
    "PENDING_AUTHORIZATION",
    "PENDING_CUSTOMER_ACTION",
    "PENDING_PAYMENT_VERIFICATION",
    "PENDING_SUPPORT_CASE",]
TransferableType = Literal["DOMAIN_IN_ANOTHER_ACCOUNT",
