...
ProcurementPortalPreferenceStatusType = Literal[
    "ACTIVE", "PENDING_VERIFICATION", "SUSPENDED", "TEST_FAILED", "TEST_INITIALIZATION_FAILED", "TEST_INITIALIZED"
]
ProtocolType = Literal["CXML"]
PurchaseOrderDataSourceTypeType = Literal["ASSOCIATED_PURCHASE_ORDER_REQUIRED", "PURCHASE_ORDER_NOT_REQUIRED"]
...
PaginatorName = Literal["list_invoice_summaries", "list_invoice_units", "list_procurement_portal_preferences"]
