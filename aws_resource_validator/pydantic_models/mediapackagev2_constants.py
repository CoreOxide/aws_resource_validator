...
EndpointErrorConditionType = Literal["INCOMPLETE_MANIFEST", "MISSING_DRM_KEY", "SLATE_INPUT", "STALE_MANIFEST"]
...
ForceEndpointErrorConfigurationUnionTypeDef = Union[   'ForceEndpointErrorConfigurationTypeDef', 'ForceEndpointErrorConfigurationExtraOutputTypeDef' ]
