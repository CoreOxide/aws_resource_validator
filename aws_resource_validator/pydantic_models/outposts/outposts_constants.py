...
CapacityTaskStatusType = Literal[
    "CANCELLATION_IN_PROGRESS", "CANCELLED", "COMPLETED", "FAILED", "IN_PROGRESS", "REQUESTED", "WAITING_FOR_EVACUATION"
]
...
LineItemStatusType = Literal[
    "BUILDING", "CANCELLED", "DELIVERED", "ERROR", "INSTALLED", "INSTALLING", "PREPARING", "REPLACED", "SHIPPED"
]
