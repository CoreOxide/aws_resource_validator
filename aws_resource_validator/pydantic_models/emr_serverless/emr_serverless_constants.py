...
ApplicationStateType = Literal["CREATED", "CREATING", "STARTED", "STARTING", "STOPPED", "STOPPING", "TERMINATED"]
ArchitectureType = Literal["ARM64", "X86_64"]
JobRunModeType = Literal["BATCH", "STREAMING"]
JobRunStateType = Literal[
    "CANCELLED", "CANCELLING", "FAILED", "PENDING", "QUEUED", "RUNNING", "SCHEDULED", "SUBMITTED", "SUCCESS"
]
...
SessionStateType = Literal["BUSY", "FAILED", "IDLE", "STARTED", "STARTING", "SUBMITTED", "TERMINATED", "TERMINATING"]
...
PaginatorName = Literal["list_applications", "list_job_run_attempts", "list_job_runs", "list_sessions"]
RegionName = Literal[
    "af-south-1",
    "ap-east-1",
    "ap-northeast-1",
