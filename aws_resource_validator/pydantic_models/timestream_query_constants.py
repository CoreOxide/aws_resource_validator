...
ScalarTypeType = Literal["BIGINT",
    ...
    "UNKNOWN",
    "VARCHAR",]
ScheduledQueryRunStatusType = Literal["AUTO_TRIGGER_FAILURE",
...
TargetConfigurationUnionTypeDef = Union[   'TargetConfigurationTypeDef', 'TargetConfigurationOutputTypeDef' ]
