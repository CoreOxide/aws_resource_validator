...
PaginatorName = Literal['list_cloud_front_origin_access_identities', 'list_distributions', 'list_invalidations', 'list_key_value_stores', 'list_public_keys', 'list_streaming_distributions']
...
ReferrerPolicyListType = Literal['no-referrer', 'no-referrer-when-downgrade', 'origin', 'origin-when-cross-origin', 'same-origin', 'strict-origin', 'strict-origin-when-cross-origin', 'unsafe-url']
