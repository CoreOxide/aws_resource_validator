...
AwsClosedLostReasonType = Literal["Administrative",
...
AwsMemberBusinessTitleType = Literal["AWSAccountOwner", "AWSSalesRep", "ISVSM", "PDM", "PSM", "WWPSPDM"]
AwsOpportunityStageType = Literal["Building Integration",
    "Business Validation",
    "Closed Incomplete",
    "Closed Lost",
    "Committed",
...
ChannelType = Literal["AWS Marketing Central",
    "Content Syndication",
    "Display",
    "Email",
    "Live Event",
    ...
    "Video",
    "Virtual Event",]
ClosedLostReasonType = Literal["Customer Deficiency",
    "Customer Experience",
    "Delay / Cancellation of Project",
    "Financial/Commercial",
    "Legal / Tax / Regulatory",
    ...
    "Security / Compliance",
    "Technical Limitations",]
CompetitorNameType = Literal["*Other",
    "Akamai",
    "AliCloud",
    "Co-location",
...
CurrencyCodeType = Literal["AED",
    ...
    "ZMW",
    "ZWL",]
DeliveryModelType = Literal["BYOL or AMI", "Managed Services", "Other", "Professional Services", "Resell", "SaaS or PaaS"]
...
ExpectedCustomerSpendCurrencyCodeEnumType = Literal["AED",
    "AFN",
    "ALL",
    "AMD",
    "ANG",
    ...
    "ZMW",
    "ZWL",]
IndustryType = Literal["Aerospace",
    "Agriculture",
    "Automotive",
...
InvolvementTypeChangeReasonType = Literal["Change in Deal Information",
    "Customer Requested",
    "Expansion Opportunity",
    "Risk Mitigation",
    "Technical Complexity",]
ListEngagementByAcceptingInvitationTasksPaginatorName = Literal["list_engagement_by_accepting_invitation_tasks"]
...
PrimaryNeedFromAwsType = Literal["Co-Sell - Architectural Validation",
...
ReasonCodeType = Literal["EngagementAccessDenied",
    "EngagementConflict",
...
ReceiverResponsibilityType = Literal["Co-Sell Facilitator",
    "Distributor",
    "Facilitator",
    "Hardware Partner",
...
ReviewStatusType = Literal["Action Required", "Approved", "In review", "Pending Submission", "Rejected", "Submitted"]
SalesActivityType = Literal["Agreed on solution to Business Problem",
...
StageType = Literal["Business Validation",
    "Closed Lost",
    "Committed",
    "Launched",
    "Prospect",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_engagement_by_accepting_invitation_tasks",
