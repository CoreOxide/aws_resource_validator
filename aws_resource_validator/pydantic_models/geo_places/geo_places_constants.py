...
GetPlaceAdditionalFeatureType = Literal["Access", "Contact", "Phonemes", "SecondaryAddresses", "TimeZone"]
...
ReverseGeocodeFilterPlaceTypeType = Literal["InterpolatedAddress", "Intersection", "Locality", "PointAddress", "Street"]
