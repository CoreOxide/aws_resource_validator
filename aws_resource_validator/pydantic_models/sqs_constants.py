...
MessageSystemAttributeNameType = Literal["AWSTraceHeader",
    "All",
    ...
    "SentTimestamp",
    "SequenceNumber",]
QueueAttributeFilterType = Literal["AWSTraceHeader",
    "All",
    "ApproximateFirstReceiveTimestamp",
    ...
    "VisibilityTimeout",]
QueueAttributeNameType = Literal["All",
    "ApproximateNumberOfMessages",
    "ApproximateNumberOfMessagesDelayed",
    "ApproximateNumberOfMessagesNotVisible",
    "ContentBasedDeduplication",
...
MessageAttributeValueUnionTypeDef = Union[   'MessageAttributeValueTypeDef', 'MessageAttributeValueExtraOutputTypeDef' ]
