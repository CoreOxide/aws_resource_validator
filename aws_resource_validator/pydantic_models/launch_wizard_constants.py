...
DeploymentStatusType = Literal["COMPLETED",
    "CREATING",
    "DELETED",
    "DELETE_FAILED",
    "DELETE_INITIATING",
    ...
    "IN_PROGRESS",
    "VALIDATING",]
EventStatusType = Literal["CANCELED", "CANCELING", "COMPLETED", "CREATED", "FAILED", "IN_PROGRESS", "PENDING", "TIMED_OUT"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_deployment_events",
    "list_deployments",
