...
AccountLimitTypeType = Literal["MAX_HEALTH_CHECKS_BY_OWNER",
...
CloudWatchRegionType = Literal["af-south-1",
    "ap-east-1",
    "ap-northeast-1",
    "ap-northeast-2",
    "ap-northeast-3",
...
ComparisonOperatorType = Literal["GreaterThanOrEqualToThreshold",
    ...
    "LessThanThreshold",]
HealthCheckRegionType = Literal["ap-northeast-1",
    "ap-southeast-1",
    "ap-southeast-2",
    "eu-west-1",
    "sa-east-1",
    ...
    "us-west-1",
    "us-west-2",]
HealthCheckTypeType = Literal["CALCULATED",
    "CLOUDWATCH_METRIC",
    "HTTP",
    "HTTPS",
    "HTTPS_STR_MATCH",
...
RRTypeType = Literal["A", "AAAA", "CAA", "CNAME", "DS", "MX", "NAPTR", "NS", "PTR", "SOA", "SPF", "SRV", "TXT"]
...
ResourceRecordSetRegionType = Literal["af-south-1",
    "ap-east-1",
    "ap-northeast-1",
    "ap-northeast-2",
    "ap-northeast-3",
...
VPCRegionType = Literal["af-south-1",
    "ap-east-1",
    "ap-northeast-1",
    "ap-northeast-2",
    "ap-northeast-3",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_cidr_blocks",
