...
AggregationTypeType = Literal['ACCOUNT', 'AMI', 'AWS_EC2_INSTANCE', 'AWS_ECR_CONTAINER', 'AWS_LAMBDA_FUNCTION', 'FINDING_TYPE', 'IMAGE_LAYER', 'LAMBDA_LAYER', 'PACKAGE', 'REPOSITORY', 'TITLE']
...
CisScanResultsAggregatedByTargetResourceSortByType = Literal['ACCOUNT_ID', 'FAILED_COUNTS', 'PLATFORM', 'RESOURCE_ID', 'TARGET_STATUS', 'TARGET_STATUS_REASON']
...
ErrorCodeType = Literal['ACCESS_DENIED', 'ACCOUNT_IS_ISOLATED', 'ALREADY_ENABLED', 'DISABLE_IN_PROGRESS', 'DISASSOCIATE_ALL_MEMBERS', 'EC2_SSM_ASSOCIATION_VERSION_LIMIT_EXCEEDED', 'EC2_SSM_RESOURCE_DATA_SYNC_LIMIT_EXCEEDED', 'ENABLE_IN_PROGRESS', 'EVENTBRIDGE_THROTTLED', 'EVENTBRIDGE_UNAVAILABLE', 'INTERNAL_ERROR', 'RESOURCE_NOT_FOUND', 'RESOURCE_SCAN_NOT_DISABLED', 'SSM_THROTTLED', 'SSM_UNAVAILABLE', 'SUSPEND_IN_PROGRESS']
...
PackageManagerType = Literal['BUNDLER', 'CARGO', 'COMPOSER', 'DOTNET_CORE', 'GEMSPEC', 'GOBINARY', 'GOMOD', 'JAR', 'NODEPKG', 'NPM', 'NUGET', 'OS', 'PIP', 'PIPENV', 'POETRY', 'POM', 'PYTHONPKG', 'YARN']
PackageSortByType = Literal['ALL', 'CRITICAL', 'HIGH']
PackageTypeType = Literal['IMAGE', 'ZIP']
PaginatorName = Literal['get_cis_scan_result_details', 'list_account_permissions', 'list_cis_scan_configurations', 'list_cis_scan_results_aggregated_by_checks', 'list_cis_scan_results_aggregated_by_target_resource', 'list_cis_scans', 'list_coverage', 'list_coverage_statistics', 'list_delegated_admin_accounts', 'list_filters', 'list_finding_aggregations', 'list_findings', 'list_members', 'list_usage_totals', 'search_vulnerabilities']
RegionName = Literal['af-south-1', 'ap-east-1', 'ap-northeast-1', 'ap-northeast-2', 'ap-northeast-3', 'ap-south-1', 'ap-southeast-1', 'ap-southeast-2', 'ap-southeast-3', 'ca-central-1', 'eu-central-1', 'eu-central-2', 'eu-north-1', 'eu-south-1', 'eu-west-1', 'eu-west-2', 'eu-west-3', 'me-south-1', 'sa-east-1', 'us-east-1', 'us-east-2', 'us-west-1', 'us-west-2']
RelationshipStatusType = Literal['ACCOUNT_SUSPENDED', 'CANNOT_CREATE_DETECTOR_IN_ORG_MASTER', 'CREATED', 'DELETED', 'DISABLED', 'EMAIL_VERIFICATION_FAILED', 'EMAIL_VERIFICATION_IN_PROGRESS', 'ENABLED', 'INVITED', 'REGION_DISABLED', 'REMOVED', 'RESIGNED']
ReportFormatType = Literal['CSV', 'JSON']
ReportingErrorCodeType = Literal['BUCKET_NOT_FOUND', 'INCOMPATIBLE_BUCKET_REGION', 'INTERNAL_ERROR', 'INVALID_PERMISSIONS', 'MALFORMED_KMS_KEY', 'NO_FINDINGS_FOUND']
...
RuntimeType = Literal['DOTNETCORE_3_1', 'DOTNET_6', 'DOTNET_7', 'GO_1_X', 'JAVA_11', 'JAVA_17', 'JAVA_8', 'JAVA_8_AL2', 'NODEJS', 'NODEJS_12_X', 'NODEJS_14_X', 'NODEJS_16_X', 'NODEJS_18_X', 'PYTHON_3_10', 'PYTHON_3_11', 'PYTHON_3_7', 'PYTHON_3_8', 'PYTHON_3_9', 'RUBY_2_7', 'RUBY_3_2', 'UNSUPPORTED']
...
SortFieldType = Literal['AWS_ACCOUNT_ID', 'COMPONENT_TYPE', 'ECR_IMAGE_PUSHED_AT', 'ECR_IMAGE_REGISTRY', 'ECR_IMAGE_REPOSITORY_NAME', 'EPSS_SCORE', 'FINDING_STATUS', 'FINDING_TYPE', 'FIRST_OBSERVED_AT', 'INSPECTOR_SCORE', 'LAST_OBSERVED_AT', 'NETWORK_PROTOCOL', 'RESOURCE_TYPE', 'SEVERITY', 'VENDOR_SEVERITY', 'VULNERABILITY_ID', 'VULNERABILITY_SOURCE']
...
UsageTypeType = Literal['EC2_INSTANCE_HOURS', 'ECR_INITIAL_SCAN', 'ECR_RESCAN', 'LAMBDA_FUNCTION_CODE_HOURS', 'LAMBDA_FUNCTION_HOURS']
