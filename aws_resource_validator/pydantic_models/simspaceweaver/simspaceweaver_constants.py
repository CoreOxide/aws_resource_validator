...
LifecycleManagementStrategyType = Literal["ByRequest", "BySpatialSubdivision", "PerWorker", "Unknown"]
...
SimulationStatusType = Literal[
    "DELETED", "DELETING", "FAILED", "SNAPSHOT_IN_PROGRESS", "STARTED", "STARTING", "STOPPED", "STOPPING", "UNKNOWN"
]
...
RegionName = Literal[
    "ap-southeast-1", "ap-southeast-2", "eu-central-1", "eu-north-1", "eu-west-1", "us-east-1", "us-east-2", "us-west-2"
]
