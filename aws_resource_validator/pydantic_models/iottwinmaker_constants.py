...
ErrorCodeType = Literal["COMPOSITE_COMPONENT_FAILURE",
    "INTERNAL_FAILURE",
    "PROCESSING_ERROR",
    "SYNC_CREATING_ERROR",
    "SYNC_DELETING_ERROR",
...
MetadataTransferJobStateType = Literal["CANCELLED", "CANCELLING", "COMPLETED", "ERROR", "PENDING", "RUNNING", "VALIDATING"]
...
UpdateReasonType = Literal["DEFAULT", "ENTITY_COUNT_UPDATE", "OVERWRITTEN", "PRICING_MODE_UPDATE", "PRICING_TIER_UPDATE"]
...
SourceConfigurationUnionTypeDef = Union[   'SourceConfigurationTypeDef', 'SourceConfigurationOutputTypeDef' ]
