...
ContentTypeType = Literal[
    "CSV", "HTML", "JSON", "MD", "MS_EXCEL", "MS_WORD", "PDF", "PLAIN_TEXT", "PPT", "RTF", "XML", "XSLT"
]
...
DocumentAttributeBoostingLevelType = Literal["HIGH", "LOW", "MEDIUM", "NONE", "ONE", "TWO", "VERY_HIGH"]
...
IdentityTypeType = Literal["ANONYMOUS", "AWS_IAM_IDC", "AWS_IAM_IDP_OIDC", "AWS_IAM_IDP_SAML", "AWS_QUICKSIGHT_IDP"]
