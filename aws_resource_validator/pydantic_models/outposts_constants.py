...
CapacityTaskFailureTypeType = Literal["BLOCKING_INSTANCES_NOT_EVACUATED",
    "INTERNAL_SERVER_ERROR",
    "RESOURCE_NOT_FOUND",
    "UNEXPECTED_ASSET_STATE",
    "UNSUPPORTED_CAPACITY_CONFIGURATION",]
CapacityTaskStatusType = Literal["CANCELLATION_IN_PROGRESS",
    "CANCELLED",
    "COMPLETED",
    "FAILED",
    "IN_PROGRESS",
...
ListBlockingInstancesForCapacityTaskPaginatorName = Literal["list_blocking_instances_for_capacity_task"]
