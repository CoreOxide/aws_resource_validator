...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_batch_inference_jobs",
...
RegionName = Literal["ap-northeast-1",
    ...
    "us-east-2",
    "us-west-2",]
BatchInferenceJobConfigUnionTypeDef = Union[   'BatchInferenceJobConfigTypeDef', 'BatchInferenceJobConfigOutputTypeDef' ]
