...
AttachmentErrorCodeType = Literal["DIRECT_CONNECT_GATEWAY_EXISTING_ATTACHMENTS",
...
AttachmentStateType = Literal["AVAILABLE",
    ...
    "REJECTED",
    "UPDATING",]
AttachmentTypeType = Literal["CONNECT", "DIRECT_CONNECT_GATEWAY", "SITE_TO_SITE_VPN", "TRANSIT_GATEWAY_ROUTE_TABLE", "VPC"]
