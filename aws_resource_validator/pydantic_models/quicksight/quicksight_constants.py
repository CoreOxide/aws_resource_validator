...
AssetBundleExportJobDataSetPropertyToOverrideType = Literal["Name", "RefreshFailureEmailAlertStatus"]
...
AuthorSpecifiedAggregationType = Literal[
    "AVERAGE", "COUNT", "DISTINCT_COUNT", "MAX", "MEDIAN", "MIN", "PERCENTILE", "STDEV", "STDEVP", "SUM", "VAR", "VARP"
]
...
DataPrepSimpleAggregationFunctionTypeType = Literal["AVERAGE", "COUNT", "DISTINCT_COUNT", "MAX", "MIN", "SUM"]
DataSetDateComparisonFilterOperatorType = Literal["AFTER", "AFTER_OR_EQUALS_TO", "BEFORE", "BEFORE_OR_EQUALS_TO"]
...
DataSetNumericComparisonFilterOperatorType = Literal[
    "DOES_NOT_EQUAL", "EQUALS", "GREATER_THAN", "GREATER_THAN_OR_EQUALS_TO", "LESS_THAN", "LESS_THAN_OR_EQUALS_TO"
]
...
DataSourceFilterAttributeType = Literal[
    "DATASOURCE_NAME", "DIRECT_QUICKSIGHT_OWNER", "DIRECT_QUICKSIGHT_SOLE_OWNER", "DIRECT_QUICKSIGHT_VIEWER_OR_OWNER"
]
...
InputColumnDataTypeType = Literal["BIT", "BOOLEAN", "DATETIME", "DECIMAL", "INTEGER", "JSON", "SEMISTRUCT", "STRING"]
...
SelfUpgradeRequestStatusType = Literal["APPROVED", "DENIED", "PENDING", "UPDATE_FAILED", "VERIFY_FAILED"]
...
TopicIRFilterFunctionType = Literal[
    "CONTAINS", "CONTAINS_STRING", "ENDS_WITH", "EXACT", "LAST", "NEXT", "NOW", "PREVIOUS", "STARTS_WITH", "THIS"
]
...
UserRoleType = Literal[
    "ADMIN", "ADMIN_PRO", "AUTHOR", "AUTHOR_PRO", "READER", "READER_PRO", "RESTRICTED_AUTHOR", "RESTRICTED_READER"
]
