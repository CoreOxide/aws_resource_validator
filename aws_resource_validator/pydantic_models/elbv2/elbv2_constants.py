...
ActionTypeEnumType = Literal[
    "authenticate-cognito", "authenticate-oidc", "fixed-response", "forward", "jwt-validation", "redirect"
]
...
JwtValidationActionAdditionalClaimFormatEnumType = Literal["single-string", "space-separated-values", "string-array"]
...
ProtocolEnumType = Literal["GENEVE", "HTTP", "HTTPS", "QUIC", "TCP", "TCP_QUIC", "TCP_UDP", "TLS", "UDP"]
