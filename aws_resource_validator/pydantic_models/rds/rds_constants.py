...
DescribeServerlessV2PlatformVersionsPaginatorName = Literal["describe_serverless_v2_platform_versions"]
...
LifecycleSupportNameType = Literal["open-source-rds-extended-support", "open-source-rds-standard-support"]
LimitlessDatabaseStatusType = Literal[
    "active", "disabled", "disabling", "enabled", "enabling", "error", "modifying-max-capacity", "not-in-use"
]
