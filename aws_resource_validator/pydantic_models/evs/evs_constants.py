...
ConnectorStateType = Literal["ACTIVE", "CREATE_FAILED", "CREATING", "DELETED", "DELETING", "UPDATE_FAILED", "UPDATING"]
ConnectorTypeType = Literal["VCENTER"]
EntitlementStatusType = Literal["AT_RISK", "CREATED", "CREATE_FAILED", "CREATING", "DELETED", "ENTITLEMENT_REMOVED"]
EntitlementTypeType = Literal["WINDOWS_SERVER"]
EnvironmentStateType = Literal["CREATED", "CREATE_FAILED", "CREATING", "DELETED", "DELETING"]
HostStateType = Literal["CREATED", "CREATE_FAILED", "CREATING", "DELETED", "DELETING", "UPDATE_FAILED", "UPDATING"]
