...
MCPServerAuthorizationMethodType = Literal["api-key", "bearer-token", "oauth-3lo", "oauth-client-credentials"]
...
RecommendationStatusType = Literal["ACCEPTED", "CLOSED", "COMPLETED", "PROPOSED", "REJECTED", "UPDATE_IN_PROGRESS"]
