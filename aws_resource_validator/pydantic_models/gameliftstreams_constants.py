...
StreamClassType = Literal["gen4n_high", "gen4n_ultra", "gen4n_win2022", "gen5n_high", "gen5n_ultra", "gen5n_win2022"]
...
StreamGroupStatusType = Literal["ACTIVATING", "ACTIVE", "ACTIVE_WITH_ERRORS", "DELETING", "ERROR", "UPDATING_LOCATIONS"]
StreamSessionActiveWaiterName = Literal["stream_session_active"]
StreamSessionStatusReasonType = Literal["applicationLogS3DestinationError", "internalError", "invalidSignalRequest", "placementTimeout"]
StreamSessionStatusType = Literal["ACTIVATING",
    "ACTIVE",
    "CONNECTED",
    "ERROR",
...
WaiterName = Literal["application_deleted",
    "application_ready",
    "stream_group_active",
