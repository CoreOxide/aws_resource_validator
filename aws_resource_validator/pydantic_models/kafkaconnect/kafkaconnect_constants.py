...
ConnectorOperationStepStateType = Literal["CANCELLED", "COMPLETED", "FAILED", "IN_PROGRESS", "PENDING"]
ConnectorOperationStepTypeType = Literal[
    "FINALIZE_UPDATE", "INITIALIZE_UPDATE", "UPDATE_CONNECTOR_CONFIGURATION", "UPDATE_WORKER_SETTING", "VALIDATE_UPDATE"
]
ConnectorOperationTypeType = Literal[
    "ISOLATE_CONNECTOR", "RESTORE_CONNECTOR", "UPDATE_CONNECTOR_CONFIGURATION", "UPDATE_WORKER_SETTING"
]
ConnectorStateType = Literal["CREATING", "DELETING", "FAILED", "RUNNING", "UPDATING"]
CustomPluginContentTypeType = Literal["JAR", "ZIP"]
CustomPluginStateType = Literal["ACTIVE", "CREATE_FAILED", "CREATING", "DELETING", "UPDATE_FAILED", "UPDATING"]
...
PaginatorName = Literal[
    "list_connector_operations", "list_connectors", "list_custom_plugins", "list_worker_configurations"
]
RegionName = Literal[
    "af-south-1",
    "ap-east-1",
