...
AnomalyDetectionTaskStatusType = Literal["COMPLETED", "FAILED", "FAILED_TO_SCHEDULE", "IN_PROGRESS", "PENDING"]
AnomalyDetectorFailureTypeType = Literal["ACTIVATION_FAILURE", "BACK_TEST_ACTIVATION_FAILURE", "DEACTIVATION_FAILURE", "DELETION_FAILURE"]
AnomalyDetectorStatusType = Literal["ACTIVATING",
    "ACTIVE",
...
DataQualityMetricTypeType = Literal["BACKTEST_INFERENCE_DATA_END_TIME_STAMP",
