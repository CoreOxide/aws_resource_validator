...
RelatedEntityTypeType = Literal["AwsMarketplaceOfferSets", "AwsMarketplaceOffers", "AwsProducts", "Solutions"]
...
StageType = Literal[
    "Business Validation", "Closed Lost", "Committed", "Launched", "Prospect", "Qualified", "Technical Validation"
]
