...
CannedAclForObjectsValueType = Literal['authenticated-read', 'aws-exec-read', 'bucket-owner-full-control', 'bucket-owner-read', 'none', 'private', 'public-read', 'public-read-write']
...
PaginatorName = Literal['describe_certificates', 'describe_connections', 'describe_data_migrations', 'describe_endpoint_types', 'describe_endpoints', 'describe_event_subscriptions', 'describe_events', 'describe_orderable_replication_instances', 'describe_replication_instances', 'describe_replication_subnet_groups', 'describe_replication_task_assessment_results', 'describe_replication_tasks', 'describe_schemas', 'describe_table_statistics']
...
SafeguardPolicyType = Literal['exclusive-automatic-truncation', 'rely-on-sql-server-replication-agent', 'shared-automatic-truncation']
...
StartReplicationMigrationTypeValueType = Literal['reload-target', 'resume-processing', 'start-replication']
...
WaiterName = Literal['endpoint_deleted', 'replication_instance_available', 'replication_instance_deleted', 'replication_task_deleted', 'replication_task_ready', 'replication_task_running', 'replication_task_stopped', 'test_connection_succeeds']