...
DescribeRcsAgentCountryLaunchStatusPaginatorName = Literal["describe_rcs_agent_country_launch_status"]
...
NotifyTemplateFilterNameType = Literal[
    "channels", "language-code", "supported-countries", "supported-voice-ids", "template-type", "tier-access"
]
