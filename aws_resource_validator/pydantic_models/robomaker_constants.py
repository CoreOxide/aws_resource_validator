...
DeploymentJobErrorCodeType = Literal["BadLambdaAssociated",
    "BadPermissionError",
...
DeploymentStatusType = Literal["Canceled", "Failed", "InProgress", "Pending", "Preparing", "Succeeded"]
...
RobotDeploymentStepType = Literal["DownloadingExtracting",
...
RobotStatusType = Literal["Available", "Deploying", "Failed", "InSync", "NoResponse", "PendingNewDeployment", "Registered"]
SimulationJobBatchErrorCodeType = Literal["InternalServiceError"]
SimulationJobBatchStatusType = Literal["Canceled",
    "Canceling",
    "Completed",
    "Completing",
    "Failed",
    ...
    "TimedOut",
    "TimingOut",]
SimulationJobErrorCodeType = Literal["BadPermissionsCloudwatchLogs",
...
SimulationJobStatusType = Literal["Canceled",
    "Completed",
    "Failed",
    "Pending",
    "Preparing",
...
WorldExportJobErrorCodeType = Literal["AccessDenied",
    "InternalServiceError",
    "InvalidInput",
    "LimitExceeded",
    "RequestThrottled",
    "ResourceNotFound",]
WorldExportJobStatusType = Literal["Canceled", "Canceling", "Completed", "Failed", "Pending", "Running"]
WorldGenerationJobErrorCodeType = Literal["AllWorldGenerationFailed",
    "InternalServiceError",
    "InvalidInput",
    "LimitExceeded",
    "RequestThrottled",
    "ResourceNotFound",]
WorldGenerationJobStatusType = Literal["Canceled", "Canceling", "Completed", "Failed", "PartialFailed", "Pending", "Running"]
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_deployment_jobs",
    "list_fleets",
