...
IdentifiedTypeType = Literal["STATELESS_RULE_CONTAINS_TCP_FLAGS", "STATELESS_RULE_FORWARDING_ASYMMETRICALLY"]
...
PerObjectSyncStatusType = Literal["CAPACITY_CONSTRAINED", "DEPRECATED", "IN_SYNC", "NOT_SUBSCRIBED", "PENDING"]
ProxyModifyStateType = Literal["COMPLETED", "FAILED", "MODIFYING"]
ProxyRulePhaseActionType = Literal["ALERT", "ALLOW", "DENY"]
ProxyStateType = Literal["ATTACHED", "ATTACHING", "ATTACH_FAILED", "DETACHED", "DETACHING", "DETACH_FAILED"]
ResourceManagedStatusType = Literal["ACCOUNT", "MANAGED"]
ResourceManagedTypeType = Literal[
    "ACTIVE_THREAT_DEFENSE", "AWS_MANAGED_DOMAIN_LISTS", "AWS_MANAGED_THREAT_SIGNATURES", "PARTNER_MANAGED"
]
...
RuleGroupTypeType = Literal["STATEFUL", "STATEFUL_DOMAIN", "STATELESS"]
...
TransitGatewayAttachmentStatusType = Literal[
    "CREATING", "DELETED", "DELETING", "ERROR", "FAILED", "PENDING_ACCEPTANCE", "READY", "REJECTED", "REJECTING"
]
