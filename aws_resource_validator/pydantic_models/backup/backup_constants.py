...
RecoveryPointStatusType = Literal["AVAILABLE", "COMPLETED", "CREATING", "DELETING", "EXPIRED", "PARTIAL", "STOPPED"]
...
ScanJobStatusType = Literal[
    "AGGREGATE_ALL", "ANY", "CANCELED", "COMPLETED", "COMPLETED_WITH_ISSUES", "CREATED", "FAILED", "RUNNING"
]
...
ScanStateType = Literal["CANCELED", "COMPLETED", "COMPLETED_WITH_ISSUES", "CREATED", "FAILED", "RUNNING"]
StorageClassType = Literal["COLD", "DELETED", "WARM"]
VaultStateType = Literal["AVAILABLE", "CREATING", "FAILED"]
VaultTypeType = Literal["BACKUP_VAULT", "LOGICALLY_AIR_GAPPED_BACKUP_VAULT", "RESTORE_ACCESS_BACKUP_VAULT"]
