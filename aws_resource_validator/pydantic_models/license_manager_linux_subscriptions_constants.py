...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_linux_subscription_instances",
...
RegionName = Literal["af-south-1",
    ...
    "us-west-1",
    "us-west-2",]
LinuxSubscriptionsDiscoverySettingsUnionTypeDef = Union[   'LinuxSubscriptionsDiscoverySettingsTypeDef', 'LinuxSubscriptionsDiscoverySettingsOutputTypeDef' ]
