...
RecommendationPillarType = Literal["cost_optimizing",
    "fault_tolerance",
    "operational_excellence",
    "performance",
    "security",
    "service_limits",]
RecommendationSourceType = Literal["aws_config",
    "compute_optimizer",
    "cost_explorer",
    "lse",
    "manual",
...
UpdateRecommendationLifecycleStageReasonCodeType = Literal["low_priority",
...
ResourceServiceName = Literal["cloudformation",
    ...
    "sns",
    "sqs",]
PaginatorName = Literal["list_checks",
