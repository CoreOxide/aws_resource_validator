# Personalize Events Personalize Events Classes
...
### ResponseMetadata
- **Type**: <class 'aws_resource_validator.pydantic_models.personalize_events.personalize_events_classes.ResponseMetadata'>
- **Required**: Yes
